...
/// TODO(mandard) Not used anymore. Safe to remove.
...
@property(nonatomic, readwrite) NSString *lastETag;
...
// TODO(mandard): investigate safe to continue removal of  old param  fetchedConfig:
