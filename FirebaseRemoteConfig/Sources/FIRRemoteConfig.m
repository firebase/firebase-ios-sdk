...
/// TODO(mandard) Rename according to obj-c style for constants.
...
+ (nonnull FIRRemoteConfig *)remoteConfigWithFIRNamespace:(NSString *_Nonnull)firebaseNamespace
  ...
  id<FIRRemoteConfigProvider> provider = FIR_COMPONENT(FIRRemoteConfigProvider,
...
- (BOOL)activateFetched {
  // TODO(mandard) We block on the async activate to complete. This method is deprecated and needs
