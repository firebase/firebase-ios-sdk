...
struct APIConfig: Sendable, Hashable, Encodable, Equatable {
...
extension APIConfig {
  ...
  enum Service: Hashable, Encodable, Equatable {
...
extension APIConfig.Service {
  ...
  enum Endpoint: String, Encodable, Equatable {
    ...
    case googleAIDirectProd = "https://generativelanguage.googleapis.com"
  }
}

extension APIConfig {
  /// Versions of the configured API service (`APIConfig.Service`).
  enum Version: String, Encodable, Equatable {
