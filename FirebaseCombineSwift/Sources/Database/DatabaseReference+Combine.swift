...
// limitations under the License.
  ...
  public extension DatabaseReference {
    ...
    func setValue<T: Encodable>(from encodable: T, encoder: Database.Encoder = Database.Encoder.defaultEncoder()) -> Future<Void, Error> {
    ...
    func observe<T: Decodable>(_ eventType: DataEventType,
                                      as type: T.Type,
                                      decoder: Database.Decoder = Database.Decoder
                                        .defaultDecoder()) -> AnyPublisher<T, Error> {
