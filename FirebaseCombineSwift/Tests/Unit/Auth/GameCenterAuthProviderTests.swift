...
class GameCenterAuthProviderTests: XCTestCase {
    ...
    class MockLocalPlayer: GKLocalPlayer {
        ...
        override func generateIdentityVerificationSignature(completionHandler: ((URL?, Data?, Data?, UInt64, Error?) -> Void)? = nil) {
        ...
        GameCenterAuthProvider.getCredential()
            .sink { completion in
                ...
                do {
                    ...
                    let gameCenterCredential = try XCTUnwrap(credential as? FIRGameCenterAuthCredential)
                    ...
                    XCTAssertEqual(gameCenterCredential.publicKeyURL.absoluteString, Self.publicKeyURL)
                    ...
                    XCTAssertEqual(gameCenterCredential.signature.base64EncodedString(), Self.signature)
    ...
    func testGetCredentialInvalidPlayerWithLocalPlayer() {
        ...
        FIRAuthBackend.setBackendImplementation(MockAuthBackend())
        MockLocalPlayer._local = MockLocalPlayer()
        MockLocalPlayer._local._errorIdentityVerificationSignature = GKError(.invalidPlayer) as NSError
