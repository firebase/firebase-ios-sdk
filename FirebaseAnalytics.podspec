Pod::Spec.new do |s|
    ...
    s.subspec 'Default' do |ss|
        ss.dependency 'GoogleAppMeasurement/Default', '11.13.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    s.subspec 'Core' do |ss|
        ss.dependency 'GoogleAppMeasurement/Core', '11.13.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    s.subspec 'IdentitySupport' do |ss|
        ss.dependency 'GoogleAppMeasurement/IdentitySupport', '11.13.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end

    # Deprecated. Use IdentitySupport subspec instead.
    s.subspec 'AdIdSupport' do |ss|
        ss.dependency 'GoogleAppMeasurement/AdIdSupport', '11.13.0'
        ss.vendored_frameworks = 'Frameworks/FirebaseAnalytics.xcframework'
    end
