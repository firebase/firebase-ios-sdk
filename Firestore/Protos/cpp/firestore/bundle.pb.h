...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_firestore_2fbundle_2eproto_metadata_getter(int index);
namespace firestore {
class BundleElement;
...
class BundledQuery PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_firestore_2fbundle_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class NamedQuery PROTOBUF_FINAL :
...
class BundledDocumentMetadata PROTOBUF_FINAL :
...
class BundleMetadata PROTOBUF_FINAL :
...
class BundleElement PROTOBUF_FINAL :
...
inline void NamedQuery::set_allocated_bundled_query(::firestore::BundledQuery* bundled_query) {
  ...
  if (bundled_query) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(bundled_query);
...
inline ::firestore::BundleMetadata* BundleElement::_internal_mutable_metadata() {
  if (!_internal_has_metadata()) {
    clear_element_type();
    set_has_metadata();
    element_type_.metadata_ = CreateMaybeMessage< ::firestore::BundleMetadata >(GetArena());
  }
...
inline ::firestore::NamedQuery* BundleElement::_internal_mutable_named_query() {
  if (!_internal_has_named_query()) {
    clear_element_type();
    set_has_named_query();
    element_type_.named_query_ = CreateMaybeMessage< ::firestore::NamedQuery >(GetArena());
  }
...
inline ::firestore::BundledDocumentMetadata* BundleElement::_internal_mutable_document_metadata() {
  if (!_internal_has_document_metadata()) {
    clear_element_type();
    set_has_document_metadata();
    element_type_.document_metadata_ = CreateMaybeMessage< ::firestore::BundledDocumentMetadata >(GetArena());
  }
...
inline ::google::firestore::v1::Document* BundleElement::_internal_mutable_document() {
  if (!_internal_has_document()) {
    clear_element_type();
    set_has_document();
    element_type_.document_ = CreateMaybeMessage< ::google::firestore::v1::Document >(GetArena());
  }
