...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_firestore_2flocal_2ftarget_2eproto_metadata_getter(int index);
namespace firestore {
namespace client {
class Target;
...
class Target PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_firestore_2flocal_2ftarget_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class TargetGlobal PROTOBUF_FINAL :
