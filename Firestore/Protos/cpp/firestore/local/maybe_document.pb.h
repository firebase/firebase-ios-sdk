...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_firestore_2flocal_2fmaybe_5fdocument_2eproto_metadata_getter(int index);
namespace firestore {
namespace client {
class MaybeDocument;
...
class NoDocument PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_firestore_2flocal_2fmaybe_5fdocument_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class UnknownDocument PROTOBUF_FINAL :
...
class MaybeDocument PROTOBUF_FINAL :
...
inline ::firestore::client::NoDocument* MaybeDocument::_internal_mutable_no_document() {
  if (!_internal_has_no_document()) {
    clear_document_type();
    set_has_no_document();
    document_type_.no_document_ = CreateMaybeMessage< ::firestore::client::NoDocument >(GetArena());
  }
...
inline ::google::firestore::v1::Document* MaybeDocument::_internal_mutable_document() {
  if (!_internal_has_document()) {
    clear_document_type();
    set_has_document();
    document_type_.document_ = CreateMaybeMessage< ::google::firestore::v1::Document >(GetArena());
  }
...
inline ::firestore::client::UnknownDocument* MaybeDocument::_internal_mutable_unknown_document() {
  if (!_internal_has_unknown_document()) {
    clear_document_type();
    set_has_unknown_document();
    document_type_.unknown_document_ = CreateMaybeMessage< ::firestore::client::UnknownDocument >(GetArena());
  }
