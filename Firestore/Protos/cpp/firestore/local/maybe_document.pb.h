...
class NoDocument final :
 ...
 public:
  ...
  ~NoDocument() override;
  explicit constexpr NoDocument(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  NoDocument* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit NoDocument(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class UnknownDocument final :
 ...
 public:
  ...
  explicit constexpr UnknownDocument(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  UnknownDocument* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit UnknownDocument(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Timestamp* release_version();
  ...
  void unsafe_arena_set_allocated_version(
      ::PROTOBUF_NAMESPACE_ID::Timestamp* version);
  ::PROTOBUF_NAMESPACE_ID::Timestamp* unsafe_arena_release_version();
...
class MaybeDocument final :
 ...
 public:
  ...
  explicit constexpr MaybeDocument(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MaybeDocument* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit MaybeDocument(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  public:
  void unsafe_arena_set_allocated_no_document(
      ::firestore::client::NoDocument* no_document);
  ...
  void unsafe_arena_set_allocated_unknown_document(
      ::firestore::client::UnknownDocument* unknown_document);
...
void NoDocument::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void NoDocument::unsafe_arena_set_allocated_read_time(
    ::PROTOBUF_NAMESPACE_ID::Timestamp* read_time) {
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* NoDocument::unsafe_arena_release_read_time() {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void UnknownDocument::set_name(ArgT0&& arg0, ArgT... args) {
...
inline void UnknownDocument::unsafe_arena_set_allocated_version(
    ::PROTOBUF_NAMESPACE_ID::Timestamp* version) {
  if (GetArenaForAllocation() == nullptr) {
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* UnknownDocument::unsafe_arena_release_version() {
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* UnknownDocument::mutable_version() {
  ::PROTOBUF_NAMESPACE_ID::Timestamp* _msg = _internal_mutable_version();
...
inline void MaybeDocument::unsafe_arena_set_allocated_no_document(::firestore::client::NoDocument* no_document) {
  clear_document_type();
  if (no_document) {
    set_has_no_document();
...
inline ::firestore::client::NoDocument* MaybeDocument::_internal_mutable_no_document() {
  if (!_internal_has_no_document()) {
    clear_document_type();
    set_has_no_document();
    document_type_.no_document_ = CreateMaybeMessage< ::firestore::client::NoDocument >(GetArenaForAllocation());
  }
...
inline void MaybeDocument::unsafe_arena_set_allocated_document(::google::firestore::v1::Document* document) {
  clear_document_type();
  if (document) {
    set_has_document();
...
inline ::google::firestore::v1::Document* MaybeDocument::_internal_mutable_document() {
  if (!_internal_has_document()) {
    clear_document_type();
    set_has_document();
    document_type_.document_ = CreateMaybeMessage< ::google::firestore::v1::Document >(GetArenaForAllocation());
  }
...
inline void MaybeDocument::unsafe_arena_set_allocated_unknown_document(::firestore::client::UnknownDocument* unknown_document) {
  clear_document_type();
  if (unknown_document) {
...
inline ::firestore::client::UnknownDocument* MaybeDocument::_internal_mutable_unknown_document() {
  if (!_internal_has_unknown_document()) {
    clear_document_type();
    set_has_unknown_document();
    document_type_.unknown_document_ = CreateMaybeMessage< ::firestore::client::UnknownDocument >(GetArenaForAllocation());
  }
