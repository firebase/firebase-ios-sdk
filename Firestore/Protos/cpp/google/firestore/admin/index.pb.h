...
enum Index_IndexField_Order : int {
  ...
  Index_IndexField_Order_Index_IndexField_Order_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Index_IndexField_Order_Index_IndexField_Order_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool Index_IndexField_Order_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Index_IndexField_Order* value) {
...
enum Index_IndexField_ArrayConfig : int {
  ...
  Index_IndexField_ArrayConfig_Index_IndexField_ArrayConfig_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Index_IndexField_ArrayConfig_Index_IndexField_ArrayConfig_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool Index_IndexField_ArrayConfig_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Index_IndexField_ArrayConfig* value) {
...
enum Index_QueryScope : int {
  ...
  Index_QueryScope_Index_QueryScope_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Index_QueryScope_Index_QueryScope_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool Index_QueryScope_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Index_QueryScope* value) {
...
enum Index_State : int {
  ...
  Index_State_Index_State_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Index_State_Index_State_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool Index_State_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Index_State* value) {
...
class Index_IndexField final :
 ...
 public:
  ...
  explicit constexpr Index_IndexField(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Index_IndexField* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit Index_IndexField(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  static inline bool ArrayConfig_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      ArrayConfig* value) {
...
class Index final :
 ...
 public:
  ...
  static inline bool QueryScope_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      QueryScope* value) {
...
void Index_IndexField::set_field_path(ArgT0&& arg0, ArgT... args) {
...
inline bool Index_IndexField::has_array_config() const {
  return _internal_has_array_config();
}
...
inline ::google::firestore::admin::v1::Index_IndexField* Index::add_fields() {
  ::google::firestore::admin::v1::Index_IndexField* _add = _internal_add_fields();
