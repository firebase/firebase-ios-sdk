...
class DocumentMask final :
 ...
 public:
  ...
  DocumentMask* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class TransactionOptions_ReadWrite final :
 ...
 public:
  ...
  void set_retry_transaction(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_retry_transaction(const std::string& value);
...
inline std::string* DocumentMask::add_field_paths() {
  std::string* _s = _internal_add_field_paths();
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* Precondition::_internal_mutable_update_time() {
  if (!_internal_has_update_time()) {
    clear_condition_type();
    set_has_update_time();
    condition_type_.update_time_ = CreateMaybeMessage< ::PROTOBUF_NAMESPACE_ID::Timestamp >(GetArenaForAllocation());
  }
...
void TransactionOptions_ReadWrite::set_retry_transaction(ArgT0&& arg0, ArgT... args) {
 
 retry_transaction_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TransactionOptions_ReadWrite::_internal_set_retry_transaction(const std::string& value) {
  ...
  retry_transaction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TransactionOptions_ReadWrite::_internal_mutable_retry_transaction() {
  
  return retry_transaction_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* TransactionOptions_ReadWrite::release_retry_transaction() {
  ...
  return retry_transaction_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void TransactionOptions_ReadWrite::set_allocated_retry_transaction(std::string* retry_transaction) {
  ...
  if (retry_transaction_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline ::google::firestore::v1::TransactionOptions_ReadOnly* TransactionOptions::_internal_mutable_read_only() {
  if (!_internal_has_read_only()) {
    clear_mode();
    set_has_read_only();
    mode_.read_only_ = CreateMaybeMessage< ::google::firestore::v1::TransactionOptions_ReadOnly >(GetArenaForAllocation());
  }
...
inline ::google::firestore::v1::TransactionOptions_ReadWrite* TransactionOptions::_internal_mutable_read_write() {
  if (!_internal_has_read_write()) {
    clear_mode();
    set_has_read_write();
    mode_.read_write_ = CreateMaybeMessage< ::google::firestore::v1::TransactionOptions_ReadWrite >(GetArenaForAllocation());
  }
