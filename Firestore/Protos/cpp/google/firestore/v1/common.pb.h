...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2ffirestore_2fv1_2fcommon_2eproto_metadata_getter(int index);
namespace google {
namespace firestore {
namespace v1 {
class DocumentMask;
...
class DocumentMask PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr DocumentMask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  protected:
  explicit DocumentMask(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2ffirestore_2fv1_2fcommon_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class Precondition PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr Precondition(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TransactionOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  void unsafe_arena_set_allocated_read_only(
      ::google::firestore::v1::TransactionOptions_ReadOnly* read_only);
  ...
  void unsafe_arena_set_allocated_read_write(
      ::google::firestore::v1::TransactionOptions_ReadWrite* read_write);
...
inline PROTOBUF_NAMESPACE_ID::Timestamp* Precondition::unsafe_arena_release_update_time() {
...
inline void Precondition::unsafe_arena_set_allocated_update_time(PROTOBUF_NAMESPACE_ID::Timestamp* update_time) {
  clear_condition_type();
  if (update_time) {
    set_has_update_time();
...
inline PROTOBUF_NAMESPACE_ID::Timestamp* Precondition::_internal_mutable_update_time() {
  if (!_internal_has_update_time()) {
    clear_condition_type();
    set_has_update_time();
    condition_type_.update_time_ = CreateMaybeMessage< PROTOBUF_NAMESPACE_ID::Timestamp >(GetArena());
  }
...
inline void TransactionOptions_ReadWrite::set_retry_transaction(const char* value) {
  ...
  retry_transaction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.firestore.v1.TransactionOptions.ReadWrite.retry_transaction)
}
inline void TransactionOptions_ReadWrite::set_retry_transaction(const void* value,
    size_t size) {
  
  retry_transaction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* TransactionOptions_ReadWrite::_internal_mutable_retry_transaction() {
  ...
  return retry_transaction_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* TransactionOptions_ReadWrite::release_retry_transaction() {
  ...
  return retry_transaction_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TransactionOptions_ReadWrite::set_allocated_retry_transaction(std::string* retry_transaction) {
  ...
  retry_transaction_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), retry_transaction,
      GetArena());
...
inline PROTOBUF_NAMESPACE_ID::Timestamp* TransactionOptions_ReadOnly::unsafe_arena_release_read_time() {
...
inline void TransactionOptions_ReadOnly::unsafe_arena_set_allocated_read_time(PROTOBUF_NAMESPACE_ID::Timestamp* read_time) {
...
inline void TransactionOptions::unsafe_arena_set_allocated_read_only(::google::firestore::v1::TransactionOptions_ReadOnly* read_only) {
  clear_mode();
  if (read_only) {
    set_has_read_only();
...
inline ::google::firestore::v1::TransactionOptions_ReadOnly* TransactionOptions::_internal_mutable_read_only() {
  if (!_internal_has_read_only()) {
    clear_mode();
    set_has_read_only();
    mode_.read_only_ = CreateMaybeMessage< ::google::firestore::v1::TransactionOptions_ReadOnly >(GetArena());
  }
...
inline void TransactionOptions::unsafe_arena_set_allocated_read_write(::google::firestore::v1::TransactionOptions_ReadWrite* read_write) {
  clear_mode();
  if (read_write) {
    set_has_read_write();
...
inline ::google::firestore::v1::TransactionOptions_ReadWrite* TransactionOptions::_internal_mutable_read_write() {
  if (!_internal_has_read_write()) {
    clear_mode();
    set_has_read_write();
    mode_.read_write_ = CreateMaybeMessage< ::google::firestore::v1::TransactionOptions_ReadWrite >(GetArena());
  }
