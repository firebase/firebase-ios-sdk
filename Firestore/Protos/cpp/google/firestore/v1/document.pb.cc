...
descriptor_table_google_2ffirestore_2fv1_2fdocument_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_google_2ffirestore_2fv1_2fdocument_2eproto);
  return descriptor_table_google_2ffirestore_2fv1_2fdocument_2eproto.file_level_metadata[index];
}
...
void Value::set_allocated_geo_point_value(::google::type::LatLng* geo_point_value) {
  ...
  if (geo_point_value) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(geo_point_value)->GetArena();
    if (message_arena != submessage_arena) {
