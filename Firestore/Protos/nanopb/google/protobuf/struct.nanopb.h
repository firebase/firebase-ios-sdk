...
#define google_protobuf_Value_init_default       {_google_protobuf_NullValue_MIN, 0, {{NULL}, NULL}, 0, google_protobuf_Struct_init_default, google_protobuf_ListValue_init_default}
...
#define google_protobuf_Value_init_zero          {_google_protobuf_NullValue_MIN, 0, {{NULL}, NULL}, 0, google_protobuf_Struct_init_zero, google_protobuf_ListValue_init_zero}
