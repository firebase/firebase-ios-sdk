...
const pb_field_t google_api_HttpRule_fields[10] = {
    ...
    PB_FIELD(  5, STRING  , SINGULAR, CALLBACK, OTHER, google_api_HttpRule, delete, post, 0),
    PB_FIELD(  6, STRING  , SINGULAR, CALLBACK, OTHER, google_api_HttpRule, patch, delete, 0),
