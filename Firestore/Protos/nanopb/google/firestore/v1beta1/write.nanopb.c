...
const pb_field_t google_firestore_v1beta1_Write_fields[6] = {
    PB_ONEOF_FIELD(operation,   1, MESSAGE , ONEOF, STATIC  , FIRST, google_firestore_v1beta1_Write, update, update, &google_firestore_v1beta1_Document_fields),
    PB_ONEOF_FIELD(operation,   2, STRING  , ONEOF, POINTER , UNION, google_firestore_v1beta1_Write, delete_, delete_, 0),
    PB_ONEOF_FIELD(operation,   6, MESSAGE , ONEOF, STATIC  , UNION, google_firestore_v1beta1_Write, transform, transform, &google_firestore_v1beta1_DocumentTransform_fields),
    PB_FIELD(  3, MESSAGE , SINGULAR, STATIC  , OTHER, google_firestore_v1beta1_Write, update_mask, operation.transform, &google_firestore_v1beta1_DocumentMask_fields),
