...
const pb_field_t google_firestore_v1beta1_Write_fields[7] = {
    ...
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, google_firestore_v1beta1_Write, delete, update, 0),
    PB_FIELD(  3, MESSAGE , SINGULAR, STATIC  , OTHER, google_firestore_v1beta1_Write, update_mask, delete, &google_firestore_v1beta1_DocumentMask_fields),
