...
const pb_field_t google_firestore_v1beta1_DocumentTransform_FieldTransform_fields[6] = {
    ...
    PB_ANONYMOUS_ONEOF_FIELD(transform_type,   3, MESSAGE , ONEOF, STATIC  , UNION, google_firestore_v1beta1_DocumentTransform_FieldTransform, numeric_add, field_path, &google_firestore_v1beta1_Value_fields),
