...
const pb_field_t google_firestore_v1_ExecutePipelineResponse_fields[5] = {
    PB_FIELD(  1, BYTES   , SINGULAR, POINTER , FIRST, google_firestore_v1_ExecutePipelineResponse, transaction, transaction, 0),
    PB_FIELD(  2, MESSAGE , REPEATED, POINTER , OTHER, google_firestore_v1_ExecutePipelineResponse, results, transaction, &google_firestore_v1_Document_fields),
    PB_FIELD(  3, MESSAGE , SINGULAR, STATIC  , OTHER, google_firestore_v1_ExecutePipelineResponse, execution_time, results, &google_protobuf_Timestamp_fields),
    PB_FIELD(  4, MESSAGE , SINGULAR, STATIC  , OTHER, google_firestore_v1_ExecutePipelineResponse, explain_stats, execution_time, &google_firestore_v1_ExplainStats_fields),
    PB_LAST_FIELD
};
...
const pb_field_t google_firestore_v1_Target_fields[9] = {
    ...
    PB_ONEOF_FIELD(target_type,  13, MESSAGE , ONEOF, STATIC  , UNION, google_firestore_v1_Target, pipeline_query, pipeline_query, &google_firestore_v1_Target_PipelineQueryTarget_fields),
    PB_ONEOF_FIELD(resume_type,   4, BYTES   , ONEOF, POINTER , OTHER, google_firestore_v1_Target, resume_token, target_type.pipeline_query, 0),
    PB_ONEOF_FIELD(resume_type,  11, MESSAGE , ONEOF, STATIC  , UNION, google_firestore_v1_Target, read_time, target_type.pipeline_query, &google_protobuf_Timestamp_fields),
...
const pb_field_t google_firestore_v1_Target_PipelineQueryTarget_fields[2] = {
    PB_ANONYMOUS_ONEOF_FIELD(pipeline_type,   1, MESSAGE , ONEOF, STATIC  , FIRST, google_firestore_v1_Target_PipelineQueryTarget, structured_pipeline, structured_pipeline, &google_firestore_v1_StructuredPipeline_fields),
    PB_LAST_FIELD
};
...
std::string google_firestore_v1_ExecutePipelineRequest::ToString(int indent) const {
    std::string tostring_header = PrintHeader(indent, "ExecutePipelineRequest", this);
    std::string tostring_result;

    tostring_result += PrintPrimitiveField("database: ",
        database, indent + 1, false);
    switch (which_pipeline_type) {
    case google_firestore_v1_ExecutePipelineRequest_structured_pipeline_tag:
        tostring_result += PrintMessageField("structured_pipeline ",
            pipeline_type.structured_pipeline, indent + 1, true);
        break;
    }
    switch (which_consistency_selector) {
    case google_firestore_v1_ExecutePipelineRequest_transaction_tag:
        tostring_result += PrintPrimitiveField("transaction: ",
            consistency_selector.transaction, indent + 1, true);
        break;
    case google_firestore_v1_ExecutePipelineRequest_new_transaction_tag:
        tostring_result += PrintMessageField("new_transaction ",
            consistency_selector.new_transaction, indent + 1, true);
        break;
    case google_firestore_v1_ExecutePipelineRequest_read_time_tag:
        tostring_result += PrintMessageField("read_time ",
            consistency_selector.read_time, indent + 1, true);
        break;
    }
...
std::string google_firestore_v1_ExecutePipelineResponse::ToString(int indent) const {
    std::string tostring_header = PrintHeader(indent, "ExecutePipelineResponse", this);
    std::string tostring_result;

    tostring_result += PrintPrimitiveField("transaction: ",
        transaction, indent + 1, false);
    for (pb_size_t i = 0; i != results_count; ++i) {
        tostring_result += PrintMessageField("results ",
            results[i], indent + 1, true);
    }
    tostring_result += PrintMessageField("execution_time ",
        execution_time, indent + 1, false);
    tostring_result += PrintMessageField("explain_stats ",
        explain_stats, indent + 1, false);
...
std::string google_firestore_v1_Target::ToString(int indent) const {
    ...
    case google_firestore_v1_Target_documents_tag:
        ...
        break;
    case google_firestore_v1_Target_pipeline_query_tag:
        tostring_result += PrintMessageField("pipeline_query ",
            target_type.pipeline_query, indent + 1, true);
        break;
    }
...
std::string google_firestore_v1_Target_PipelineQueryTarget::ToString(int indent) const {
    std::string tostring_header = PrintHeader(indent, "PipelineQueryTarget", this);
    std::string tostring_result;

    switch (which_pipeline_type) {
    case google_firestore_v1_Target_PipelineQueryTarget_structured_pipeline_tag:
        tostring_result += PrintMessageField("structured_pipeline ",
            structured_pipeline, indent + 1, true);
        break;
    }
