...
public struct RealtimePipeline: @unchecked Sendable {
  ...
  public func addSnapshotListener(options: SnapshotListenOptions,
                                  listener: @escaping (RealtimePipelineSnapshot?, Error?) -> Void)
    -> ListenerRegistration {
    return bridge.addSnapshotListener(options: options) { snapshotBridge, error in
      listener(
  ...
  public func asyncThrowingStream() -> AsyncThrowingStream<RealtimePipelineSnapshot, Error> {
