 ...
 */
fileprivate protocol CodableDocumentSnapshot: Codable {}

/** The keys in a GeoPoint. Must match the properties of CodableGeoPoint. */
fileprivate enum DocumentSnapshotKeys: String, CodingKey {
  case data
}

extension CodableDocumentSnapshot {
...
extension DocumentSnapshot: CodableDocumentSnapshot {}
