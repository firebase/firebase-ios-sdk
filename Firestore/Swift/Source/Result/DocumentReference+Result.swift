...
extension DocumentReference {
  ...
  func setData(_ documentData: [String: Any], completion: @escaping (_ result: Result<Void, Error>) -> Void) {
  ...
  ///   It will not be called while the client is offline, though local changes will be visible immediately.
  ///   - result: The result of request. On success it is empty, otherwise it contains an `Error`.
  func setData(_ documentData: [String: Any], merge: Bool, completion: @escaping (_ result: Result<Void, Error>) -> Void) {
  ...
  ///   It will not be called while the client is offline, though local changes will be visible immediately.
  ///   - result: The result of request. On success it is empty, otherwise it contains an `Error`.
  func setData(_ documentData: [String: Any], mergeFields: [Any], completion: @escaping (_ result: Result<Void, Error>) -> Void) {
  ...
  func setData<T: Encodable>(from value: T, encoder: Firestore.Encoder = Firestore.Encoder(), completion: @escaping (_ result: Result<Void, Error>) -> Void) throws {
  ...
  /// - Throws: `Firestore.Encoder` encoding errors:
  ///   - *put list of possible errors*
  func setData<T: Encodable>(from value: T, merge: Bool, encoder: Firestore.Encoder = Firestore.Encoder(), completion: @escaping (_ result: Result<Void, Error>) -> Void) throws {
    try setData(from: value, merge: merge, encoder: encoder, completion: mapResultClosure(completion))
  }
  ...
  /// - Throws: `Firestore.Encoder` encoding errors:
  ///   - *put list of possible errors*
  func setData<T: Encodable>(from value: T, mergeFields: [Any], encoder: Firestore.Encoder = Firestore.Encoder(), completion: @escaping (_ result: Result<Void, Error>) -> Void) throws {
    try setData(from: value, mergeFields: mergeFields, encoder: encoder, completion: mapResultClosure(completion))
  }
  ...
  ///   It will not be called while the client is offline, though local changes will be visible immediately.
  ///   - result: The result of request. On success it is empty, otherwise it contains an `Error`.
  func updateData(_ fields: [AnyHashable: Any], completion: @escaping (_ result: Result<Void, Error>) -> Void) {
  ...
  func getDocument(source: FirestoreSource = .default, completion: @escaping (_ result: Result<DocumentSnapshot, Error>) -> Void) {
  ...
  func addSnapshotListener(includeMetadataChanges: Bool = false, listener: @escaping (_ result: Result<DocumentSnapshot, Error>) -> Void) -> ListenerRegistration {
    addSnapshotListener(includeMetadataChanges: includeMetadataChanges, listener: mapResultClosure(listener))
  }
}
...
private func mapResultClosure<T>(_ completion: @escaping (_ result: Result<T, Error>) -> Void) -> ((T?, Error?) -> Void) {
  { value, error in
    if let value = value {
...
///   - result: The parameter of the closure to map.
/// - Returns: A closure mapped from the given closure.
private func mapResultClosure<E>(_ completion: @escaping (_ result: Result<Void, E>) -> Void) -> ((E?) -> Void) {
  { error in
    if let error = error {
      completion(.failure(error))
    } else {
