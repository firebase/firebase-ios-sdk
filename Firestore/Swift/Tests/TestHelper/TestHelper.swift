...
public enum TestHelper {
  // This data is shared between all pipeline tests. Modifying it may affect test expectations.
  public static let bookDocs: [String: [String: Sendable]] = [
    "book1": [
    ...
    "book6": [
      ...
      "awards": ["none": true],
      "embedding": VectorValue([1, 1, 1, 1, 10, 1, 1, 1, 1]), // Fixed size to 10
    ],
    "book7": [
