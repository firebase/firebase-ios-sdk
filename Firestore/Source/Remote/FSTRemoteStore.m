...
- (instancetype)initWithRemoteStore:(FSTRemoteStore *)remoteStore
                             stream:(FSTStream *)stream NS_DESIGNATED_INITIALIZER;
...
- (instancetype)initWithRemoteStore:(FSTRemoteStore *)remoteStore stream:(FSTStream *)stream {
  if (self = [super init]) {
...
- (instancetype)initWithRemoteStore:(FSTRemoteStore *)delegate stream:(FSTStream *)stream {
  if (self = [super init]) {
    _invokeCallbacks = YES;
    _delegate = delegate;
    _stream = stream;
