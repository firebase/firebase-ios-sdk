...
- (instancetype)initWithGetLocation:(FSTGetLocation)getLocation {
  if (self = [super init]) {
...
+ (instancetype)fromDefault {
  return [[FIRGetOptions alloc] initWithGetLocation:FSTGetFromDefault];
}

+ (instancetype)fromServer {
  return [[FIRGetOptions alloc] initWithGetLocation:FSTGetFromServer];
}

+ (instancetype)fromCache {
  return [[FIRGetOptions alloc] initWithGetLocation:FSTGetFromCache];
}
