...
TEST(FieldValue, ObjectType) {
  const FieldValue empty =
      FieldValue::ObjectValue(std::map<std::string, const FieldValue>{});
  std::map<std::string, const FieldValue> object{
  ...
  std::map<std::string, const FieldValue> another_object{
