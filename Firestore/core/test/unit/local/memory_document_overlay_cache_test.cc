...
TEST(MemoryDocumentOverlayCacheTest, TypeTraits) {
  static_assert(std::is_constructible<MemoryDocumentOverlayCache>::value,
                "is_constructible");
  static_assert(std::is_destructible<MemoryDocumentOverlayCache>::value,
                "is_destructible");
  static_assert(
      std::is_default_constructible<MemoryDocumentOverlayCache>::value,
