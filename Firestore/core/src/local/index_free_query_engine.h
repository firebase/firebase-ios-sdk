...
#ifndef FIRESTORE_CORE_SRC_LOCAL_INDEX_FREE_QUERY_ENGINE_H_
#define FIRESTORE_CORE_SRC_LOCAL_INDEX_FREE_QUERY_ENGINE_H_
...
#endif  // FIRESTORE_CORE_SRC_LOCAL_INDEX_FREE_QUERY_ENGINE_H_
