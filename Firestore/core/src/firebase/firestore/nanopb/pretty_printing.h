...
#ifndef FIRESTORE_CORE_SRC_FIREBASE_FIRESTORE_NANOPB_PRETTY_PRINTING_H_
#define FIRESTORE_CORE_SRC_FIREBASE_FIRESTORE_NANOPB_PRETTY_PRINTING_H_
...
#endif  // FIRESTORE_CORE_SRC_FIREBASE_FIRESTORE_NANOPB_PRETTY_PRINTING_H_
