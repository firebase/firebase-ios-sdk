...
using nanopb::google_firestore_v1_BatchGetDocumentsRequest;
using nanopb::google_firestore_v1_BatchGetDocumentsResponse;
using nanopb::google_firestore_v1_CommitRequest;
using nanopb::google_firestore_v1_ListenRequest;
...
using nanopb::google_firestore_v1_WriteRequest;
