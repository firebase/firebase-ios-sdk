...
class FieldValue {
 public:
  ...
  using ObjectT = std::map<std::string, FieldValue>;
  ...
  const ObjectT& object_value() const {
  ...
  static FieldValue ObjectValue(const ObjectT& value);
  static FieldValue ObjectValue(ObjectT&& value);
