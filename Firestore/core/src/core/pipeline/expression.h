...
#ifndef FIRESTORE_CORE_SRC_CORE_PIPELINE_EXPRESSION_H_
#define FIRESTORE_CORE_SRC_CORE_PIPELINE_EXPRESSION_H_
...
#endif  // FIRESTORE_CORE_SRC_CORE_PIPELINE_EXPRESSION_H_
