...
#ifndef FIRESTORE_CORE_SRC_CORE_PIPELINE_EVALUATION_COMPARISON_H_
#define FIRESTORE_CORE_SRC_CORE_PIPELINE_EVALUATION_COMPARISON_H_
...
#endif  // FIRESTORE_CORE_SRC_CORE_PIPELINE_EVALUATION_COMPARISON_H_
