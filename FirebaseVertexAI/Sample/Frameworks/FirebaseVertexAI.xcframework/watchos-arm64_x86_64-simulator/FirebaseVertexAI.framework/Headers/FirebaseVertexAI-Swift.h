...
#pragma clang attribute push(                                                                  \
    __attribute__((external_source_symbol(language = "Swift", defined_in = "FirebaseVertexAI", \
...
SWIFT_CLASS("_TtC16FirebaseVertexAI8VertexAI")
SWIFT_AVAILABILITY(watchos, introduced = 8.0) SWIFT_AVAILABILITY(tvos, introduced = 15.0)
    SWIFT_AVAILABILITY(maccatalyst, introduced = 15.0) SWIFT_AVAILABILITY(macos, introduced = 11.0)
        SWIFT_AVAILABILITY(ios, introduced = 15.0) @interface VertexAI : NSObject
...
SWIFT_CLASS_NAMED("FirebaseVertexAIComponent")
@interface FIRVertexAIComponent : NSObject
