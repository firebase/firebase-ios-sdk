...
let package = Package(
  ...
  targets: [
    ...
    .target(
      name: "FirebaseCoreInternalSwift",
      dependencies: ["FirebaseCore"],
      path: "FirebaseCoreInternalSwift/Sources"
    ),
    .testTarget(
      name: "CoreInternalUnitSwift",
      dependencies: ["FirebaseCoreInternalSwift"],
      path: "FirebaseCoreInternalSwift/Tests/Unit"
    ),
    .target(
