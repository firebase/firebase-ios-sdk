...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "FirebaseAnalytics",
      url: "https://dl.google.com/firebase/ios/swiftpm/10.23.0/FirebaseAnalytics.zip",
      checksum: "3fb2f7a91480cffd1dfe9c8f212626cf67860f2686f4ec74122df0e9b411ec53"
    ),
    .target(
...
func googleAppMeasurementDependency() -> Package.Dependency {
  ...
  return .package(url: appMeasurementURL, exact: "10.23.0")
}
...
func firestoreTargets() -> [Target] {
  ...
  let firestoreInternalTarget: Target = {
    if ProcessInfo.processInfo.environment["FIREBASECI_USE_LOCAL_FIRESTORE_ZIP"] != nil {
      ...
      return .binaryTarget(
        name: "FirebaseFirestoreInternal",
        url: "https://dl.google.com/firebase/ios/bin/firestore/10.23.0/rc0/FirebaseFirestoreInternal.zip",
        checksum: "ced3ce4ab1b34cf74b5f05d48100cc0c74e8d62926e12324e7bb29772bcda09f"
      )
    }
  }()
