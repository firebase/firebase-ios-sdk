...
//    ),
  ...
  targets: [
    ...
    .binaryTarget(
      name: "FirebaseAnalytics",
      url: "https://dl.google.com/firebase/ios/swiftpm/7.11.1/FirebaseAnalytics.zip",
      checksum: "ed5aa9898d9cf10c354cff0047dca688e66790604626b482e3cc8e34cd50a506"
    ),
    .target(
