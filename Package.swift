...
func packageDependencies() -> [Package.Dependency] {
  ...
  #if os(macOS)
    // Add Apple-only dependencies when building on macOS hosts.
...
func firestoreTargets() -> [Target] {
  ...
  let firestoreInternalTarget: Target = {
    if Context.environment["FIREBASECI_USE_LOCAL_FIRESTORE_ZIP"] != nil {
      ...
      return .binaryTarget(
        name: "FirebaseFirestoreInternal",
        url: "https://dl.google.com/firebase/ios/bin/firestore/12.18.0/rc0/FirebaseFirestoreInternal.zip",
        checksum: "482aaf7dfbb97672a4094caa1df617a70812380fe899104e6d21010fe6d555e6"
      )
    }
  }()
