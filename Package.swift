  ...
  targets: [
    ...
    .testTarget(
      ...
      exclude: [
        ...
        "FIRMessagingContextManagerServiceTest.m",
        "FIRMessagingExtensionHelperTest.m",
        "FIRMessagingFakeKeychain.h",
