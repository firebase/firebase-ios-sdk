...
func grpcDependency() -> Package.Dependency {
  return .package(url: "https://github.com/google/grpc-binary.git", branch: "nc/firestore-pre_rc1")
  // let packageInfo: (url: String, range: Range<Version>)
...
func firestoreTargets() -> [Target] {
  ...
  let firestoreInternalTarget: Target = {
    if ProcessInfo.processInfo.environment["FIREBASECI_USE_LOCAL_FIRESTORE_ZIP"] != nil {
      ...
      return .binaryTarget(
        name: "FirebaseFirestoreInternal",
        url: "https://dl.google.com/firebase/ios/bin/firestore/11.0.0/pre_rc1/FirebaseFirestoreInternal.zip",
        checksum: "7f53722a5e37c8c431f715dd223cdf59175a1426b5b09932e963dd58ae4656b8"
      )
    }
  }()
