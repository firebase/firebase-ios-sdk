...
public extension GenAITypes {
  ...
  struct JSONDate: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - year: Year of the date. Must be from 1 to 9999, or 0 to specify a date without (Gemini
    /// Enterprise Agent Platform only). For more details, see ``year``.
    ///   - month: Month of a year. Must be from 1 to 12, or 0 to specify a year without a (Gemini
