...
public extension GenAITypes {
  ...
  struct CountTokensResponse: Codable, Sendable, Equatable, Hashable {
    ...
    /// (behavior varies by backend). For more details, see ``totalTokens``.
    ///   - cachedContentTokenCount: Number of tokens in the cached part of the prompt (the cached
    /// content). (Gemini Developer API only). For more details, see ``cachedContentTokenCount``.
    ///   - promptTokensDetails: Output only. List of modalities that were processed in the request
    /// input.
    ///   - cacheTokensDetails: Output only. List of modalities that were processed in the cached
    /// content. (Gemini Developer API only). For more details, see ``cacheTokensDetails``.
