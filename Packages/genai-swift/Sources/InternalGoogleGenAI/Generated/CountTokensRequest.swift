...
public extension GenAITypes {
  ...
  struct CountTokensRequest: Codable, Sendable, Equatable, Hashable {
    ...
    ///   - systemInstruction: Optional. The user provided system instructions for the model.
    /// (Gemini Enterprise Agent Platform only). For more details, see ``systemInstruction``.
