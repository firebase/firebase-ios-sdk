...
public extension GenAITypes {
  ...
  struct ReviewSnippet: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - reviewId: The ID of the review snippet. (behavior varies by backend). For more details,
    /// see ``reviewId``.
    ///   - googleMapsUri: A link that corresponds to the user review on Google Maps. (behavior
