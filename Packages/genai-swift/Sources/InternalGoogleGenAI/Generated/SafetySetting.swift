...
public extension GenAITypes {
  ...
  /// threshold for that
  /// category.
  struct SafetySetting: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - category: Required. The category for this setting. (behavior varies by backend). For
    /// more details, see ``category``.
