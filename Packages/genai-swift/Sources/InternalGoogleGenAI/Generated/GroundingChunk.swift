...
public extension GenAITypes {
  ...
  struct GroundingChunk: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - web: Grounding chunk from the web. (behavior varies by backend). For more details, see
    /// ``web``.
    ///   - image: Optional. Grounding chunk from image search. (behavior varies by backend). For
