...
public extension GenAITypes {
  ...
  struct LogprobsResultCandidate: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - token: The candidate’s token string value. (behavior varies by backend). For more
    /// details, see ``token``.
    ///   - tokenId: The candidate’s token id value. (behavior varies by backend). For more details,
    /// see ``tokenId``.
