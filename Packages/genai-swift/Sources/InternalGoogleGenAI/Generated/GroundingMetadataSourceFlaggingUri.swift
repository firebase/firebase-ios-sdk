...
public extension GenAITypes {
  ...
  struct GroundingMetadataSourceFlaggingUri: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - sourceId: The ID of the place or review. (Gemini Enterprise Agent Platform only). For
