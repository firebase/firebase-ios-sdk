...
public extension GenAITypes {
  ...
  struct APIError: Codable, Sendable, Equatable, Hashable {
...
public extension GenAITypes.APIError {
  ...
  enum RPCErrorStatus: Codable, Sendable, Equatable, Hashable {
  ...
  enum Detail: Codable, Sendable, Equatable, Hashable {
    ...
    case unrecognized(GenAITypes.JSONObject)
    ...
    public init(from decoder: Decoder) throws {
      ...
      case "type.googleapis.com/google.rpc.ErrorInfo":
        self = try .errorInfo(ErrorInfo(from: decoder))
      case "type.googleapis.com/google.rpc.LocalizedMessage":
        self = try .localizedMessage(LocalizedMessage(from: decoder))
      case "type.googleapis.com/google.rpc.Help":
        self = try .help(Help(from: decoder))
      default:
        self = try .unrecognized(GenAITypes.JSONObject(from: decoder))
      }
    }

    public func encode(to encoder: Encoder) throws {
      switch self {
      case let .errorInfo(value):
        try value.encode(to: encoder)
      case let .localizedMessage(value):
        try value.encode(to: encoder)
      case let .help(value):
        try value.encode(to: encoder)
  ...
  struct ErrorInfo: Codable, Sendable, Equatable, Hashable {
  ...
  struct LocalizedMessage: Codable, Sendable, Equatable, Hashable {
  ...
  struct Help: Codable, Sendable, Equatable, Hashable {
...
extension GenAITypes.APIError.RPCErrorStatus: RawRepresentable {
...
extension GenAITypes.APIError: LocalizedError {
  public var errorDescription: String? {
    if let details = error.details {
      for detail in details {
        if case let .localizedMessage(localizedMessage) = detail {
  ...
  public var failureReason: String? {
    if let details = error.details {
      for detail in details {
        if case let .errorInfo(errorInfo) = detail {
  ...
  public var helpAnchor: String? {
    if let details = error.details {
      for detail in details {
        if case let .help(help) = detail, let firstLink = help.links.first {
...
extension GenAITypes.APIError: CustomNSError {
  ...
  public var errorUserInfo: [String: Any] {
    ...
    if let details = error.details {
      for detail in details {
        ...
        case let .localizedMessage(localizedMessage):
          userInfo["locale"] = localizedMessage.locale
        case let .unrecognized(obj):
          if var prevAdditional = userInfo["additionalDetails"] as? [GenAITypes.JSONObject] {
