...
public struct Part: Codable, Sendable, Equatable, Hashable {
  ...
  ///
  /// - Parameters:
  ///   - toolCall: Server-side tool call. This field is populated when the model (Gemini Developer
  /// API only). For more details, see ``toolCall``.
  ...
  public init(from decoder: Decoder) throws {
    ...
    partMetadata = try container.decodeIfPresent([String: JSONValue].self, forKey: .partMetadata)
