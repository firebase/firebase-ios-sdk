...
/// model and executed by the client. The name of the function must be listed in
/// the template frontmatter for the model to be able to call it.
public struct TemplateFunction: Codable, Sendable, Equatable, Hashable {
  ...
  ///   - inputSchema: Optional. Describes the parameters to the function in JSON Schema format. The
  /// schema
