...
public struct FunctionDeclaration: Codable, Sendable, Equatable, Hashable {
  ...
  ///
  /// - Parameters:
  ///   - name: Required. The name of the function. (behavior varies by backend). For more details,
  /// see ``name``.
  ///   - description: Required. A brief description of the function. (behavior varies by backend).
