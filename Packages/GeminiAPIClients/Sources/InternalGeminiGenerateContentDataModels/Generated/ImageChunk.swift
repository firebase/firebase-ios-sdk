...
/// information.
public struct ImageChunk: Codable, Sendable, Equatable, Hashable {
  ...
  ///
  /// - Parameters:
  ///   - sourceUri: The web page URI for attribution. (behavior varies by backend). For more
  /// details, see ``sourceUri``.
  ///   - imageUri: The image asset URL. (behavior varies by backend). For more details, see
  /// ``imageUri``.
  ///   - title: The title of the web page that the image is from. (behavior varies by backend). For
  /// more details, see ``title``.
