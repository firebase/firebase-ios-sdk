...
public struct RetrievalMetadata: Codable, Sendable, Equatable, Hashable {
  ...
  ///
  /// - Parameters:
  ///   - googleSearchDynamicRetrievalScore: Optional. Score indicating how likely information from
  /// google search could help (behavior varies by backend). For more details, see
