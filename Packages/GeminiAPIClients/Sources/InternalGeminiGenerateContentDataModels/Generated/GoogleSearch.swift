...
public struct GoogleSearch: Codable, Sendable, Equatable, Hashable {
  ...
  ///   - excludeDomains: Optional. List of domains to be excluded from the search results. (Gemini
  /// Enterprise Agent Platform only). For more details, see ``excludeDomains``.
