...
public struct SearchTypes: Codable, Sendable, Equatable, Hashable {
  ...
  ///
  /// - Parameters:
  ///   - webSearch: Optional. Enables web search. Only text results are returned. (behavior varies
  /// by backend). For more details, see ``webSearch``.
  ///   - imageSearch: Optional. Enables image search. Image bytes are returned. (behavior varies by
  /// backend). For more details, see ``imageSearch``.
