...
public struct Decrypt: ParsableCommand {
  public static let configuration = CommandConfiguration(
    abstract: "Decrypt the secret files for a test run.",
    usage: """
      decrypt [--json] [--overwrite] [<json-file>]
      decrypt [--password <password>] [--overwrite] [<secret-files> ...]

      decrypt --json secret_files.json
      decrypt --json --overwrite secret_files.json
      decrypt --password "super_secret" \\
  ...
  static let log = Logger(label: "Decrypt")
