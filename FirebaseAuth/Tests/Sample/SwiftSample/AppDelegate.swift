...
public class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  static weak var gOpenURLDelegate: OpenURLDelegate?
  public var window: UIWindow?
  var sampleAppMainViewController: MainViewController?

  @objc class func setOpenURLDelegate(_ openURLDelegate: OpenURLDelegate?) -> Void {
  ...
  public func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    sampleAppMainViewController = MainViewController(nibName: NSStringFromClass(MainViewController.self),                                                  bundle:nil)
    sampleAppMainViewController?.navigationItem.title = "Firebase Auth"
    window.rootViewController = UINavigationController(rootViewController: sampleAppMainViewController!)
    self.window = window
  ...
  public func application(
    ...
    if (Self.gOpenURLDelegate!.handleOpenURL(url, sourceApplication: options[UIApplication.OpenURLOptionsKey.sourceApplication] as! String)) {
      return true
    }
