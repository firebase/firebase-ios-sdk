...
@objc(FIRTOTPSecret) public class TOTPSecret: NSObject {
   ...
   */
  @objc public func generateQRCodeURLWithAccountName(accountName: String, issuer: String) -> String {
  ...
  init(secretKey: String, hashingAlgorithm: String, codeLength: Int, codeIntervalSeconds: Int, enrollmentCompletionDeadline: Date, sessionInfo: String) {
