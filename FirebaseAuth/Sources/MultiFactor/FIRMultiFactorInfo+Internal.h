...
// Note that we're not able to indicate FIRMultiFactorInfo conforming to NSSecureCoding in an internal header file, the following NSSecureCoding methods are explicitly declared.
