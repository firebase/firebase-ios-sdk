...
static NSString *const kFIRAuthErrorMessageInvalidVerificationCode =
    @"The multifactor verification code used to create the auth credential is invalid. Please recollect "
     "the verification code and be sure to use the verification code provided by the user.";
