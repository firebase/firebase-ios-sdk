...
package struct GenerateContentRequest: Codable, Sendable, Equatable, Hashable {
  ...
  ///   - systemInstruction: Optional. Developer set [system (behavior varies by backend). For more
  /// details, see ``systemInstruction``.
  ...
  ///   - toolConfig: Optional. Tool configuration for any `Tool` specified in the request. Refer to
  /// the (behavior varies by backend). For more details, see ``toolConfig``.
