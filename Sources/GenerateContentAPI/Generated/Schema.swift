...
package final class Schema: Codable, Sendable {
  ...
  ///   - title: Optional. The title of the schema. (behavior varies by backend). For more details,
  /// see ``title``.
  ...
  ///   - nullable: Optional. Indicates if the value may be null. (behavior varies by backend). For
  /// more details, see ``nullable``.
  ...
  ///   - required: Optional. Required properties of Type.OBJECT. (behavior varies by backend). For
  /// more details, see ``required``.
  ...
  ///   - minimum: Optional. SCHEMA FIELDS FOR TYPE INTEGER and NUMBER (behavior varies by backend).
  /// For more details, see ``minimum``.
  ...
  ///   - minLength: Optional. SCHEMA FIELDS FOR TYPE STRING (behavior varies by backend). For more
  /// details, see ``minLength``.
  ...
  /// (behavior varies by backend). For more details, see ``example``.
  ///   - anyOf: Optional. The value should be validated against any (one or more) of the subschemas
  /// (behavior varies by backend). For more details, see ``anyOf``.
  ///   - propertyOrdering: Optional. The order of the properties. (behavior varies by backend). For
  /// more details, see ``propertyOrdering``.
  ...
  ///   - additionalProperties: Optional. If `type` is `OBJECT`, specifies how to handle properties
  /// not defined in (Gemini Enterprise Agent Platform only). For more details, see
...
extension Schema: Equatable, Hashable {
  package static func == (lhs: Schema, rhs: Schema) -> Bool {
    return
      lhs.type == rhs.type &&
