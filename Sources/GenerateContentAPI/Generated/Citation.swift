...
package struct Citation: Codable, Sendable, Equatable, Hashable {
  ...
  ///
  /// - Parameters:
  ///   - startIndex: Optional. Start of segment of the response that is attributed to this source.
  ...
  ///   - publicationDate: Output only. The publication date of the source of the citation. (Gemini
  /// Enterprise Agent Platform only). For more details, see ``publicationDate``.
