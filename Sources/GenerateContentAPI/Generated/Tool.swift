...
package struct Tool: Codable, Sendable, Equatable, Hashable {
  ...
  /// functions whose
  ///   - googleMaps: Optional. Tool to retrieve public maps data for grounding, powered by Google.
  /// (behavior varies by backend). For more details, see ``googleMaps``.
  ///   - functionDeclarations: Optional. A list of `FunctionDeclarations` available to the model
  /// that can be used (behavior varies by backend). For more details, see ``functionDeclarations``.
