...
extension Schema: Equatable, Hashable {
  package static func == (
    ...
    return
      lhs.type == rhs.type && lhs.format == rhs.format && lhs.title == rhs.title
      && lhs.description == rhs.description && lhs.nullable == rhs.nullable
      && lhs.`enum` == rhs.`enum` && lhs.items == rhs.items && lhs.maxItems == rhs.maxItems
      && lhs.minItems == rhs.minItems && lhs.properties == rhs.properties
      && lhs.required == rhs.required && lhs.minProperties == rhs.minProperties
      && lhs.maxProperties == rhs.maxProperties && lhs.minimum == rhs.minimum
      && lhs.maximum == rhs.maximum && lhs.minLength == rhs.minLength
      && lhs.maxLength == rhs.maxLength && lhs.pattern == rhs.pattern && lhs.example == rhs.example
      && lhs.anyOf == rhs.anyOf && lhs.propertyOrdering == rhs.propertyOrdering
      && lhs.`default` == rhs.`default` && lhs.additionalProperties == rhs.additionalProperties
      && lhs.ref == rhs.ref && lhs.defs == rhs.defs
  }
