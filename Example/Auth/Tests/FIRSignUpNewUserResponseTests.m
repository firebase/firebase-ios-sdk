...
/** @fn testMissingEmailError
    @brief This test simulates making a request without an email address parameter where one is
        expected and receiving @c FIRAuthErrorMissingEmail error as a result.
 */
