...
- (void)testQueryParamsEquals {
  ...
  {  // startAt with childkey equals
    FQueryParams *params1 =
        [[FQueryParams defaultInstance] startAt:[FEmptyNode emptyNode] childKey:@"key"];
    FQueryParams *params2 =
        [[FQueryParams defaultInstance] startAt:[FEmptyNode emptyNode] childKey:@"key"];
    FQueryParams *params3 =
        [[FQueryParams defaultInstance] startAt:[FEmptyNode emptyNode] childKey:@"other-key"];
    XCTAssertEqualObjects(params1, params2);
    XCTAssertEqual(params1.hash, params2.hash);
    XCTAssertFalse([params1 isEqual:params3]);
  }
  ...
  {  // endAt with childkey equals
    FQueryParams *params1 =
        [[FQueryParams defaultInstance] endAt:[FEmptyNode emptyNode] childKey:@"key"];
    FQueryParams *params2 =
        [[FQueryParams defaultInstance] endAt:[FEmptyNode emptyNode] childKey:@"key"];
    FQueryParams *params3 =
        [[FQueryParams defaultInstance] endAt:[FEmptyNode emptyNode] childKey:@"other-key"];
    XCTAssertEqualObjects(params1, params2);
    XCTAssertEqual(params1.hash, params2.hash);
    XCTAssertFalse([params1 isEqual:params3]);
  }
