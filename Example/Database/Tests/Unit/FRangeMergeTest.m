...
- (void)testStartIsExclusive {
  ...
  FRangeMerge *merge =
      [[FRangeMerge alloc] initWithStart:PATH(@"bar") end:PATH(@"foo") updates:updates];
...
- (void)testLeafsAreUpdatedWhenRangesIncludeDeeperPath {
  ...
  FRangeMerge *merge =
      [[FRangeMerge alloc] initWithStart:PATH(@"foo") end:PATH(@"foo/bar/deep") updates:updates];
...
- (void)testUpdatingRangeWithRightPostChildOfLeftPostWorks {
  ...
  FRangeMerge *merge =
      [[FRangeMerge alloc] initWithStart:PATH(@"foo") end:PATH(@"foo/b/1") updates:updates];
...
- (void)testUpdatingRangeWithRightPostChildOfLeftPostWorksWithIntegerKeys {
  ...
  FRangeMerge *merge =
      [[FRangeMerge alloc] initWithStart:PATH(@"foo") end:PATH(@"foo/b/2") updates:updates];
...
- (void)updatingPriorityInChildrenNodeWorksAlone {
  ...
  FRangeMerge *merge =
      [[FRangeMerge alloc] initWithStart:nil end:PATH(@".priority") updates:updates];
...
- (void)testPriorityIsDeletedWhenIncludedInChildrenRange {
  ...
  FRangeMerge *merge =
      [[FRangeMerge alloc] initWithStart:nil end:PATH(@"bar") updates:updates];  // deletes priority
