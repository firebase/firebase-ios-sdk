...
- (void)testCompoundHashCanSplitAtPriority {
  ...
  FCompoundHash *hash =
      [FCompoundHash fromNode:node splitStrategy:[self splitAtPaths:@[ PATH(@"foo/.priority") ]]];
...
- (void)testHashingFollowsFirebaseKeySemantics {
  ...
  FCompoundHash *hash =
      [FCompoundHash fromNode:node splitStrategy:[self splitAtPaths:@[ PATH(@"2") ]]];
  NSString *firstHash =
...
- (void)testHashingOnChildBoundariesWorks {
  id<FNode> node = NODE((
      @{ @"bar" : @{@"deep" : @"value"},
         @"foo" : @{@"other-deep" : @"value"} }));
  FCompoundHash *hash =
      [FCompoundHash fromNode:node splitStrategy:[self splitAtPaths:@[ PATH(@"bar/deep") ]]];
  NSString *firstHash =
