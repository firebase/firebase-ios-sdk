...
- (void)testCompoundWriteWithPriorityUpdateIsNotEmpty {
  FCompoundWrite *compoundWrite =
      [[FCompoundWrite emptyWrite] addWrite:self.priorityNode atKey:@".priority"];
...
- (void)testCompoundWriteWithRootUpdateIsNotEmpty {
  FCompoundWrite *compoundWrite =
      [[FCompoundWrite emptyWrite] addWrite:self.leafNode atPath:[FPath empty]];
...
- (void)testCompoundWriteWithEmptyRootUpdateIsNotEmpty {
  FCompoundWrite *compoundWrite =
      [[FCompoundWrite emptyWrite] addWrite:[FEmptyNode emptyNode] atPath:[FPath empty]];
...
- (void)testAppliesChildrenOverwrite {
  FCompoundWrite *compoundWrite = [FCompoundWrite emptyWrite];
  id<FNode> childNode =
      [[FEmptyNode emptyNode] updateImmediateChild:@"child" withNewChild:self.leafNode];
...
- (void)testOverwritesExistingChild {
  ...
  id<FNode> expectedNode =
      [self.baseNode updateImmediateChild:[path getFront] withNewChild:self.leafNode];
...
- (void)testDeepPrioritySetWorksOnEmptyNodeWhenOtherSetIsAvailable {
  FCompoundWrite *compoundWrite = [FCompoundWrite emptyWrite];
  compoundWrite =
      [compoundWrite addWrite:self.priorityNode atPath:[[FPath alloc] initWith:@"foo/.priority"]];
  compoundWrite =
      [compoundWrite addWrite:self.leafNode atPath:[[FPath alloc] initWith:@"foo/child"]];
  id<FNode> updatedNode = [compoundWrite applyToNode:[FEmptyNode emptyNode]];
...
- (void)testRootUpdateRemovesRootPriority {
  FCompoundWrite *compoundWrite = [FCompoundWrite emptyWrite];
  compoundWrite =
      [compoundWrite addWrite:self.priorityNode atPath:[[FPath alloc] initWith:@".priority"]];
...
- (void)testAddingUpdatesAtPathWorks {
  ...
  compoundWrite =
      [compoundWrite addCompoundWrite:updates atPath:[[FPath alloc] initWith:@"child-1"]];
...
- (void)testCompleteChildrenOnlyReturnsCompleteOverwrites {
  ...
  NSArray *expectedChildren =
      @[ [[FNamedNode alloc] initWithName:@"child-1" andNode:self.leafNode] ];
...
- (void)testCompleteChildrenOnlyReturnsEmptyOverwrites {
  FCompoundWrite *compoundWrite = [FCompoundWrite emptyWrite];
  compoundWrite =
      [compoundWrite addWrite:[FEmptyNode emptyNode] atPath:[[FPath alloc] initWith:@"child-1"]];
  NSArray *expectedChildren =
      @[ [[FNamedNode alloc] initWithName:@"child-1" andNode:[FEmptyNode emptyNode]] ];
  NSArray *completeChildren = [compoundWrite completeChildren];
  XCTAssertEqualObjects(completeChildren, expectedChildren,
...
- (void)testCompleteChildrenDoesntReturnDeepOverwrites {
  FCompoundWrite *compoundWrite = [FCompoundWrite emptyWrite];
  compoundWrite =
      [compoundWrite addWrite:self.leafNode atPath:[[FPath alloc] initWith:@"child-1/deep/path"]];
  NSArray *expectedChildren = @[];
  NSArray *completeChildren = [compoundWrite completeChildren];
  XCTAssertEqualObjects(completeChildren, expectedChildren,
...
- (void)testCompleteChildrenReturnAllCompleteChildrenButNoIncomplete {
  ...
  compoundWrite =
      [compoundWrite addWrite:[FEmptyNode emptyNode] atPath:[[FPath alloc] initWith:@"child-3"]];
...
- (void)testCompoundWriteWithDeepUpdateHasShadowingWrite {
  FCompoundWrite *compoundWrite = [FCompoundWrite emptyWrite];
  compoundWrite =
      [compoundWrite addWrite:self.leafNode atPath:[[FPath alloc] initWith:@"deep/update"]];
...
- (void)testRemoveAtRootAlsoRemovesPriority {
  ...
  compoundWrite = [compoundWrite
      addWrite:[[FLeafNode alloc] initWithValue:@"foo" withPriority:self.priorityNode]
        atPath:[FPath empty]];
...
- (void)testUpdatingPriorityDoesntOverwriteLeafNode {
  ...
  compoundWrite = [compoundWrite addWrite:self.leafNode atPath:[FPath empty]];
  compoundWrite =
      [compoundWrite addWrite:self.priorityNode atPath:[[FPath alloc] initWith:@"child/.priority"]];
  id<FNode> updatedNode = [compoundWrite applyToNode:[FEmptyNode emptyNode]];
...
- (void)testUpdatingEmptyChildNodeDoesntOverwriteLeafNode {
  ...
  compoundWrite = [compoundWrite addWrite:self.leafNode atPath:[FPath empty]];
  compoundWrite =
      [compoundWrite addWrite:[FEmptyNode emptyNode] atPath:[[FPath alloc] initWith:@"child"]];
  id<FNode> updatedNode = [compoundWrite applyToNode:[FEmptyNode emptyNode]];
  XCTAssertEqualObjects(updatedNode, self.leafNode,
