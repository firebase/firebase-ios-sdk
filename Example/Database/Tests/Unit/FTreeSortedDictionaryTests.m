...
- (void)testCreateNode {
  FTreeSortedDictionary* map = [[[FTreeSortedDictionary alloc]
      initWithComparator:[self defaultComparator]] insertKey:@"key"
                                                   withValue:@"value"];
...
- (void)testMoreRemovals {
  FTreeSortedDictionary* map =
      [[[[[[[[[[[[[[FTreeSortedDictionary alloc] initWithComparator:[self defaultComparator]]
          insertKey:@1
          withValue:@1] insertKey:@50
                        withValue:@50] insertKey:@3
                                       withValue:@3] insertKey:@4
                                                     withValue:@4] insertKey:@7
                                                                   withValue:@7] insertKey:@9
                                                                                 withValue:@9]
          insertKey:@20
          withValue:@20] insertKey:@18
                         withValue:@18] insertKey:@2
                                        withValue:@2] insertKey:@71
                                                      withValue:@71] insertKey:@42
                                                                     withValue:@42] insertKey:@88
                                                                                    withValue:@88];
...
- (void)testStructureShouldBeValidAfterInsertionC {
  ...
  FTreeSortedDictionary* m3 =
      [[[[m2 insertKey:@71 withValue:@71] insertKey:@42 withValue:@42] insertKey:@88 withValue:@88]
          insertKey:@20
          withValue:@20];  // Add a dupe to see if the size is correct
...
- (void)testOverride {
  FTreeSortedDictionary* map =
      [[[[FTreeSortedDictionary alloc] initWithComparator:[self defaultComparator]] insertKey:@10
                                                                                    withValue:@10]
          insertKey:@10
          withValue:@8];
