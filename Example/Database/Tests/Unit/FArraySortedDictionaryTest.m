...
- (void)testSearchForSpecificKey {
  FImmutableSortedDictionary *map =
      [[[[FArraySortedDictionary alloc] initWithComparator:[self defaultComparator]] insertKey:@1
                                                                                     withValue:@1]
          insertKey:@2
          withValue:@2];
...
- (void)testOverride {
  FImmutableSortedDictionary *map =
      [[[[FArraySortedDictionary alloc] initWithComparator:[self defaultComparator]] insertKey:@10
                                                                                     withValue:@10]
          insertKey:@10
          withValue:@8];
