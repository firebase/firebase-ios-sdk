...
* **No New Objective-C**: Reject any PR that introduces new Objective-C public
  APIs or new Objective-C files unless there is a strong, explicitly
  documented justification (e.g., C-interop). General code updates to existing
  Objective-C files are perfectly acceptable.
