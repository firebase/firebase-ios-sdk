...
bool FIRCLSContextInitialize(FIRCLSInternalReport* report,
  ...
  // To initialize Crashlytics handlers even if the Xcode debugger is attached, replace this check with YES.
  // Note that this is only possible to do on an actual device as it will cause the simulator to crash.
