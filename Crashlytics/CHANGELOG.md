# Unreleased
- [changed] Updated `upload-symbols` to version 3.21, updated error logging in `upload-symbols` and started reading the `DEVELOPER_DIR` environment varibale for the path to Xcode for CoreSymbolication.
