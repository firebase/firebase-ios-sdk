...
const NSString *FIRCLSTestSettingsInverse =
    ...
    @"\"identifier_mask\":255, \"on_demand_upload_rate\":15, \"on_demand_backoff_base_exponent\":3, \"on_demand_backoff_step_duration\":8}}";
...
- (void)testDefaultSettings {
  ...
  XCTAssertEqual(self.settings.onDemandBackoffBaseExponent, 2);
...
- (void)testInverseDefaultSettingsCached {
  ...
  XCTAssertEqual(self.settings.onDemandBackoffStepDuration, 8);
}
