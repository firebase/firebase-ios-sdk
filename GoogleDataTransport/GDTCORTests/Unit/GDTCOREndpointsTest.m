...
- (void)testUploadURLsAreCorrect {
  ...
  XCTAssertEqualObjects([GDTCOREndpoints uploadURLForTarget:kGDTCORTargetCCT], uploadURLs[@(kGDTCORTargetCCT)]);
  XCTAssertEqualObjects([GDTCOREndpoints uploadURLForTarget:kGDTCORTargetFLL], uploadURLs[@(kGDTCORTargetFLL)]);
  XCTAssertEqualObjects([GDTCOREndpoints uploadURLForTarget:kGDTCORTargetCSH], uploadURLs[@(kGDTCORTargetCSH)]);
  XCTAssertEqualObjects([GDTCOREndpoints uploadURLForTarget:kGDTCORTargetINT], uploadURLs[@(kGDTCORTargetINT)]);
}
