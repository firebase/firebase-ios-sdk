...
public struct SystemInstructions: Sendable {
  ...
  public init(_ content: some SystemInstructionsRepresentable) {
    parts = content.systemInstructionsRepresentation.parts
  }

  public init(@SystemInstructionsBuilder _ content: () throws -> SystemInstructions) rethrows {
    self = try content()
  }
...
extension SystemInstructions: SystemInstructionsRepresentable {
