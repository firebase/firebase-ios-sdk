...
public struct ThinkingConfig: Sendable, Equatable {
  ...
  ///     The range of [supported thinking budget values][1] depends on the model.
  ...
  ///
  /// [1]: https://firebase.google.com/docs/ai-logic/thinking#supported-thinking-budget-values
