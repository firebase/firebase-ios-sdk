...
public enum InferenceMode: Sendable { case preferOnDevice, preferInCloud }

public struct HybridModel: LanguageModel {
  let cloud: any LanguageModel
  ...
  public func _startSession(tools: [any ToolRepresentable]?,
    ...
    switch mode {
    case .preferOnDevice:
      return HybridModelSession(primary: deviceSession, secondary: cloudSession)
    case .preferInCloud:
      return HybridModelSession(primary: cloudSession, secondary: deviceSession)
    }
  }
}
