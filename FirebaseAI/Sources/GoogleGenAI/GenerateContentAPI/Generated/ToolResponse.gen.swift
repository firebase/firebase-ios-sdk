...
extension GenerateContentAPI {
  ...
  struct ToolResponse: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - id: Optional. The identifier of the tool call this response is for. (Gemini Developer
    /// API only). For more details, see ``id``.
    ///   - toolType: Required. The type of tool that was called, matching the `tool_type` in the
