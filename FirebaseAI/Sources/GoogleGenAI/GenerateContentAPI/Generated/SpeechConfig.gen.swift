...
extension GenerateContentAPI {
  ...
  struct SpeechConfig: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - voiceConfig: The configuration in case of single-voice output. (behavior varies by
    /// backend). For more details, see ``voiceConfig``.
    ///   - multiSpeakerVoiceConfig: Optional. The configuration for the multi-speaker setup.
    ...
    init(voiceConfig: VoiceConfig? = nil,
