...
extension GenerateContentAPI {
  ...
  /// on model prediction.
  struct FunctionResponse: Codable, Sendable, Equatable, Hashable {
    ...
    let response: [String: ProtobufValue]?
    ...
    ///
    /// - Parameters:
    ///   - id: Required. ID of the individual function invocation assigned by the model when it
    /// (behavior varies by backend). For more details, see ``id``.
    ///   - name: Required. The name of the function. (behavior varies by backend). For more
    /// details, see ``name``.
    ///   - response: Optional. The results of the function invocation. (behavior varies by
    /// backend). For more details, see ``response``.
    ///   - willContinue: Optional. Signals that function call continues, and more responses will be
