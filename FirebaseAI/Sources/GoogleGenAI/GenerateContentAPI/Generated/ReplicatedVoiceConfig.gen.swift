...
extension GenerateContentAPI {
  ...
  struct ReplicatedVoiceConfig: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// Optional. The sample of the custom voice.
    let voiceSampleAudio: Data?

    /// Creates a new `ReplicatedVoiceConfig`.
    ///
    /// - Parameters:
    ///   - mimeType: Optional. The mimetype of the voice sample. The only currently supported value
