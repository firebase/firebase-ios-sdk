...
extension GenerateContentAPI {
  ...
  struct MapsRoute: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - distanceMeters: The total distance of the route, in meters. (Gemini Enterprise Agent
    /// Platform only). For more details, see ``distanceMeters``.
    ///   - duration: The total duration of the route. (Gemini Enterprise Agent Platform only). For
