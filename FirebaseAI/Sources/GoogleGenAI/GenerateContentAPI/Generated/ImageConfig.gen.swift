...
extension GenerateContentAPI {
  ...
  /// images of people.
  struct ImageConfig: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// Optional. The image output format for generated images.
    let imageOutputOptions: ImageConfigImageOutputOptions?
    ...
    /// people.
    let prominentPeople: ProminentPeople?

    /// Creates a new `ImageConfig`.
    ///
    /// - Parameters:
    ///   - aspectRatio: Optional. The aspect ratio of the image to generate. Supported aspect
    /// ratios: `1:1`, (behavior varies by backend). For more details, see ``aspectRatio``.
    ///   - imageSize: Optional. Specifies the size of generated images. Supported values are `512`,
    /// `1K`, (behavior varies by backend). For more details, see ``imageSize``.
    ///   - imageOutputOptions: Optional. The image output format for generated images. (Gemini
    /// Enterprise Agent Platform only). For more details, see ``imageOutputOptions``.
    ///   - personGeneration: Optional. Controls whether the model can generate people. (Gemini
    /// Enterprise Agent Platform only). For more details, see ``personGeneration``.
