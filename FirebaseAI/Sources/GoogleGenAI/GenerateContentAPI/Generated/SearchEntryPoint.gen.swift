...
extension GenerateContentAPI {
  ...
  struct SearchEntryPoint: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - renderedContent: Optional. Web content snippet that can be embedded in a web page or an
    ...
    init(renderedContent: String? = nil,
         sdkBlob: Data? = nil) {
