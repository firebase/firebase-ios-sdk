...
extension GenerateContentAPI {
  ...
  ///
  /// Different types of search that can be enabled on the GoogleSearch tool.
  struct SearchTypes: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - webSearch: Optional. Enables web search. Only text results are returned. (behavior
