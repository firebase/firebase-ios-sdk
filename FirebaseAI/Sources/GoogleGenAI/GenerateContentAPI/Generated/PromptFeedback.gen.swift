...
extension GenerateContentAPI {
  ...
  struct PromptFeedback: Codable, Sendable, Equatable, Hashable {
    ...
    /// (behavior varies by backend). For more details, see ``blockReason``.
    ///   - safetyRatings: Ratings for safety of the prompt. (behavior varies by backend). For more
    /// details, see ``safetyRatings``.
    ...
    /// ``blockReasonMessage``.
    init(blockReason: BlockReason? = nil,
