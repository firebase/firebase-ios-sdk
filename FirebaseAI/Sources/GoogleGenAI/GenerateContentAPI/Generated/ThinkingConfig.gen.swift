...
extension GenerateContentAPI {
  ...
  /// response.
  struct ThinkingConfig: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - includeThoughts: Indicates whether to include thoughts in the response. (behavior varies
    /// by backend). For more details, see ``includeThoughts``.
    ///   - thinkingBudget: The number of thoughts tokens that the model should generate. (behavior
