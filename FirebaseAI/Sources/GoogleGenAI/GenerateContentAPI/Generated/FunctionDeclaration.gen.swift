...
extension GenerateContentAPI {
  ...
  struct FunctionDeclaration: Codable, Sendable, Equatable, Hashable {
    ...
    let parametersJsonSchema: ProtobufValue?
    ...
    ///
    /// - Parameters:
    ///   - name: Required. The name of the function. (behavior varies by backend). For more
    /// details, see ``name``.
    ///   - description: Required. A brief description of the function. (behavior varies by
    /// backend). For more details, see ``description``.
    ///   - parameters: Optional. Describes the parameters to this function. Reflects the Open API
    /// 3.03 (behavior varies by backend). For more details, see ``parameters``.
    ///   - parametersJsonSchema: Optional. Describes the parameters to the function in JSON Schema
    /// format. The schema
    ///   - response: Optional. Describes the output from this function in JSON Schema format.
    /// Reflects the
    ///   - responseJsonSchema: Optional. Describes the output from this function in JSON Schema
    /// format. The value
