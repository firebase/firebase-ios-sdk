...
extension GenerateContentAPI {
  ...
  struct ToolCall: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - id: Optional. Unique identifier of the tool call. (Gemini Developer API only). For more
    /// details, see ``id``.
    ///   - toolType: Required. The type of tool that was called. (Gemini Developer API only). For
