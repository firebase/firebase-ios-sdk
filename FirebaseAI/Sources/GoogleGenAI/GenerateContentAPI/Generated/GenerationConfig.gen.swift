...
extension GenerateContentAPI {
  ...
  /// the output.
  struct GenerationConfig: Codable, Sendable, Equatable, Hashable {
    ...
    let responsejsonschema: ProtobufValue?
    ...
    ///   - responseMimeType: Optional. MIME type of the generated candidate text. (behavior varies
    /// by backend). For more details, see ``responseMimeType``.
    ///   - responseSchema: Optional. Output schema of the generated candidate text. Schemas must be
    /// a (behavior varies by backend). For more details, see ``responseSchema``.
    ...
    ///   - responseModalities: Optional. The requested modalities of the response. Represents the
    /// set of modalities (behavior varies by backend). For more details, see
    /// ``responseModalities``.
    ///   - speechConfig: Optional. The speech generation config.
    ///   - thinkingConfig: Optional. Config for thinking features. (behavior varies by backend).
    /// For more details, see ``thinkingConfig``.
    ///   - imageConfig: Optional. Config for image generation. (behavior varies by backend). For
    /// more details, see ``imageConfig``.
    ...
    ///   - enableAffectiveDialog: Optional. If enabled, the model will detect emotions and adapt
    /// its responses (behavior varies by backend). For more details, see ``enableAffectiveDialog``.
    ///   - responseFormat: Optional. Configuration for the response output format. Allows
