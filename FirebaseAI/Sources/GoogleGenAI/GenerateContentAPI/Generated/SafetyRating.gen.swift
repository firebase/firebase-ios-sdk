...
extension GenerateContentAPI {
  ...
  struct SafetyRating: Codable, Sendable, Equatable, Hashable {
    ...
    /// threshold.
    let overwrittenThreshold: OverwrittenThreshold?

    /// Creates a new `SafetyRating`.
    ///
    /// - Parameters:
    ///   - category: Required. The category for this rating. (behavior varies by backend). For more
    /// details, see ``category``.
    ///   - probability: Required. The probability of harm for this content. (behavior varies by
    /// backend). For more details, see ``probability``.
    ///   - blocked: Was this content blocked because of this rating? (behavior varies by backend).
    /// For more details, see ``blocked``.
    ///   - probabilityScore: Output only. The probability score of harm for this category. (Gemini
    /// Enterprise Agent Platform only). For more details, see ``probabilityScore``.
    ///   - severity: Output only. The severity of harm for this category. (Gemini Enterprise Agent
    /// Platform only). For more details, see ``severity``.
    ///   - severityScore: Output only. The severity score of harm for this category. (Gemini
    ...
    init(category: HarmCategory? = nil,
