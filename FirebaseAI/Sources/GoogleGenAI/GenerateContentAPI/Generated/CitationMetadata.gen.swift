...
extension GenerateContentAPI {
  ...
  struct CitationMetadata: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - citationSources: Citations to sources for a specific response. (Gemini Developer API
    ...
    init(citationSources: [Citation]? = nil,
