...
extension GenerateContentAPI {
  ...
  struct FunctionCall: Codable, Sendable, Equatable, Hashable {
    ...
    ///   - name: Required. The name of the function to be invoked. (behavior varies by backend).
    /// For more details, see ``name``.
    ///   - args: Optional. Inputs to the function passed by the model (behavior varies by backend).
