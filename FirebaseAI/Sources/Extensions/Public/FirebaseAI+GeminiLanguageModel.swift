...
// limitations under the License.
  ...
  public extension FirebaseAI {
    ...
    ///   - compatibilityOptions: Overrides for behavior that depends on current
    ///     Gemini backend semantics. Defaults to the recommended values; see
    ...
    func geminiLanguageModel(name: String,
                             compatibilityOptions: GeminiLanguageModel.CompatibilityOptions =
                               GeminiLanguageModel.CompatibilityOptions()) -> GeminiLanguageModel {
      GeminiLanguageModel(
        name: name,
        firebaseAI: self,
