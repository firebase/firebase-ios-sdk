...
public final class FirebaseAI: Sendable {
  ...
  ///     ](https://firebase.google.com/docs/ai-logic/gemini-models#available-model-names) for a
  ...
  // TODO: Remove the `#if compiler(>=6.2.3)` when Xcode 26.2 is the minimum supported version.
    ...
    ///     ](https://firebase.google.com/docs/ai-logic/gemini-models#available-model-names)
