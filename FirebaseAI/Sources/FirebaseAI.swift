...
public final class FirebaseAI: Sendable {
  ...
  ///
  /// - Parameters:
  ///   - modelName: The name of the model to use; see [available model names][1] for a list of
  ...
  // TODO: Remove the `#if compiler(>=6.2.3)` when Xcode 26.2 is the minimum supported version.
    ...
    ///
    /// - Parameters:
    ///   - name: The name of the model to use; see [available model names][1] for a list of
    ///     supported model names.
    ...
    ///
    /// - Parameters:
    ///   - model: The name of the model to use; see [available model names][1] for a list of
    ///     supported model names.
  ...
  ///
  /// - Note: Refer to [the Firebase docs on the Live API][1] for
  /// guidance on choosing an appropriate model for your use case.
  ///
  ...
  ///   - requestOptions: Configuration parameters for sending requests to the backend.
  ///
  /// [1]: https://firebase.google.com/docs/ai-logic/live-api#models-that-support-capability
  @available(watchOS, unavailable)
