...
struct SchemaTests {
  ...
  @Test(arguments: InstanceConfig.allConfigs) // Schema items are supported by all remaining configs
  ...
  @Test(arguments: InstanceConfig.allConfigs) // Schema number range is supported by all remaining configs
  ...
  @Test(arguments: InstanceConfig.allConfigs) // Schema number range multi-type is supported by all remaining configs
  ...
  @Test(arguments: InstanceConfig.allConfigs) // anyOf schema is supported by all remaining configs
