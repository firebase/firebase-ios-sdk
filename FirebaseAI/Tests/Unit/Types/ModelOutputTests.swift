...
class ModelOutputTests: XCTestCase {
  ...
  @available(watchOS, unavailable)
  func testConvertibleFromGeneratedContentIsConvertibleFromModelOutput() throws {
    struct PersonConvertibleFromGeneratedContent: ConvertibleFromGeneratedContent, ConvertibleFromModelOutput {
      let name: String
      let age: Int
  ...
  @available(watchOS, unavailable)
  func testConvertibleToGeneratedContentIsConvertibleToModelOutput() throws {
    struct PersonConvertibleToGeneratedContent: ConvertibleToGeneratedContent, ConvertibleToModelOutput {
      let name: String
      let age: Int
