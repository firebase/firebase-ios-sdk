 ...
 * @return Returns a promise that is resolved with the checkin object when all required data found in the Keychain. The promise is rejected when the data is missing.
 */
