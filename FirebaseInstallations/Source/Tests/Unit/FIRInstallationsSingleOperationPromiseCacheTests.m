...
- (void)assertRaceConditionWithParallelOperationCount:(NSInteger)count {
  FIRInstallationsSingleOperationPromiseCache *promiseCache = [[FIRInstallationsSingleOperationPromiseCache alloc] initWithNewOperationHandler:^FBLPromise * _Nonnull {
