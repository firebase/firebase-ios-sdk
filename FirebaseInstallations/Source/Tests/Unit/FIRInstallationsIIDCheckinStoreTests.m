...
@property(nonatomic) FIRInstallationsIIDCheckinStore *IIDCheckinStore;
@end

@implementation FIRInstallationsIIDCheckinStoreTests

- (void)setUp {
  self.IIDCheckinStore = [[FIRInstallationsIIDCheckinStore alloc] init];
}

- (void)tearDown {
  self.IIDCheckinStore = nil;
}

- (void)testExistingCheckin_WhenNoCheckin_ThenFails {
  FBLPromise *checkinPromise = [self.IIDCheckinStore existingChecking];
