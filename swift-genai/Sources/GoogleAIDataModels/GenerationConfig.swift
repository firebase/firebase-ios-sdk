...
extension GoogleAI {
  ...
  package struct GenerationConfig: Codable, Sendable, Equatable, Hashable {
    ...
    package var enableEnhancedCivicAnswers: Bool?
    ...
    package var responseFormat: ResponseFormatConfig?
    ...
    package var thinkingConfig: ThinkingConfig?
    ...
    package var translationConfig: TranslationConfig?
