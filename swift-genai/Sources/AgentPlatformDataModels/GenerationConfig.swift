...
extension AgentPlatform {
  ...
  package struct GenerationConfig: Codable, Sendable, Equatable, Hashable {
    ...
    package var audioTimestamp: Bool?
    ...
    package var enableAffectiveDialog: Bool?
    ...
    package var imageConfig: ImageConfig?
    ...
    package var mediaResolution: MediaResolution?
    
    /// Optional. Config for model selection.
    @available(*, deprecated)
    package var modelConfig: GenerationConfigModelConfig?
    ...
    package var responseLogprobs: Bool?
    ...
    package var responseModalities: [String]?
    ...
    @available(*, deprecated)
    package var responseSchema: Schema?
    
    /// Optional. Routing configuration.
    package var routingConfig: GenerationConfigRoutingConfig?
