...
extension AgentPlatform {
  ...
  package struct ExternalApi: Codable, Sendable, Equatable, Hashable {
    ...
    package var apiAuth: ApiAuth?
    
    /// The API spec that the external API implements.
    package var apiSpec: ApiSpec?
    
    /// The authentication config to access the API.
    package var authConfig: AuthConfig?
    
    /// Parameters for the elastic search API.
    package var elasticSearchParams: ExternalApiElasticSearchParams?
    
    /// The endpoint of the external API. The system will call the API at this endpoint to retrieve the data for grounding. Example: https://acme.com:443/search
    package var endpoint: String?
    
    /// Parameters for the simple search API.
    package var simpleSearchParams: ExternalApiSimpleSearchParams?
