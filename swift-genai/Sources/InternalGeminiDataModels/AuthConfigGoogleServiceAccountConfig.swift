...
extension GeminiDataModels {
  /// An internal data model for `AuthConfigGoogleServiceAccountConfig`.
  /// 
  ...
  package struct AuthConfigGoogleServiceAccountConfig: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - serviceAccount: Optional. The service account that the extension execution service runs as. (Gemini Enterprise Agent Platform only). For more details, see ``serviceAccount``.
    package init(
