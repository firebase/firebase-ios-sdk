...
extension GeminiDataModels {
  ...
  package struct Interval: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - startTime: Optional. Inclusive start of the interval. (Gemini Developer API only). For more details, see ``startTime``.
    ///   - endTime: Optional. Exclusive end of the interval. (Gemini Developer API only). For more details, see ``endTime``.
    package init(
