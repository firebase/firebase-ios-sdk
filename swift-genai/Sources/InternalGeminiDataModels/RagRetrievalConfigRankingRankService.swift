...
extension GeminiDataModels {
  /// An internal data model for `RagRetrievalConfigRankingRankService`.
  /// 
  ...
  /// 
  /// Type: `GoogleCloudAiplatformV1beta1RagRetrievalConfigRankingRankService`
  /// 
  ...
  package struct RagRetrievalConfigRankingRankService: Codable, Sendable, Equatable, Hashable {
    ...
    ///
    /// - Parameters:
    ///   - modelName: Optional. The model name of the rank service. (Gemini Enterprise Agent Platform only). For more details, see ``modelName``.
    package init(
