 ...
 *
 *  NOTE: If your application does not use APNS, you should consider using
 *  + [GULAppDelegateSwizzler proxyOriginalDelegateWithoutRemoteNotificationMethods] instead to
 *  avoid risk of warnings from Apple review about missing Push Notification Entitlement (like
 *  https://github.com/firebase/firebase-ios-sdk/issues/2807)
 *
 *  @see proxyOriginalDelegateWithoutRemoteNotificationMethods
 */
 ...
 *  proxyOriginalDelegate]. The methods have to be proxied separately to
