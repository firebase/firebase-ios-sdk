...
+ (Class)originalAppDelegateClass {
  return gOriginalAppDelegateClass;
}

+ (NSDictionary *)originalImplementationBySelectorString {
  id appDelegate = [GULAppDelegateSwizzler sharedApplication].delegate;
  return objc_getAssociatedObject(appDelegate, &kGULRealIMPBySelectorKey);
}
