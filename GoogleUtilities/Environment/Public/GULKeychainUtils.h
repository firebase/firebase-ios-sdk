...
#ifndef GOOGLEUTILITIES_ENVIRONMENT_PUBLIC_GULKEYCHAINUTILS_H_
#define GOOGLEUTILITIES_ENVIRONMENT_PUBLIC_GULKEYCHAINUTILS_H_
...
#endif  // GOOGLEUTILITIES_ENVIRONMENT_PUBLIC_GULKEYCHAINUTILS_H_
