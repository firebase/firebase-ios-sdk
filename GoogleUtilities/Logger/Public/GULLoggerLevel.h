...
#ifndef GOOGLEUTILITIES_LOGGER_PUBLIC_GULLOGGERLEVEL_H_
#define GOOGLEUTILITIES_LOGGER_PUBLIC_GULLOGGERLEVEL_H_
...
#endif  // GOOGLEUTILITIES_LOGGER_PUBLIC_GULLOGGERLEVEL_H_
