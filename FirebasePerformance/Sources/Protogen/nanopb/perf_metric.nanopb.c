...
const pb_field_t firebase_perf_v1_TraceMetric_fields[9] = {
    ...
    PB_FIELD(  7, MESSAGE , REPEATED, CALLBACK, OTHER, firebase_perf_v1_TraceMetric, subtraces, counters, &firebase_perf_v1_TraceMetric_fields),
    ...
    PB_FIELD(  9, MESSAGE , REPEATED, CALLBACK, OTHER, firebase_perf_v1_TraceMetric, perf_sessions, custom_attributes, &firebase_perf_v1_PerfSession_fields),
    PB_LAST_FIELD
};

const pb_field_t firebase_perf_v1_TraceMetric_CountersEntry_fields[3] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, firebase_perf_v1_TraceMetric_CountersEntry, key, key, 0),
...
const pb_field_t firebase_perf_v1_TraceMetric_CustomAttributesEntry_fields[3] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, firebase_perf_v1_TraceMetric_CustomAttributesEntry, key, key, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, CALLBACK, OTHER, firebase_perf_v1_TraceMetric_CustomAttributesEntry, value, key, 0),
    PB_LAST_FIELD
};
...
const pb_field_t firebase_perf_v1_NetworkRequestMetric_fields[14] = {
    ...
    PB_FIELD( 13, MESSAGE , REPEATED, CALLBACK, OTHER, firebase_perf_v1_NetworkRequestMetric, perf_sessions, custom_attributes, &firebase_perf_v1_PerfSession_fields),
    PB_LAST_FIELD
};

const pb_field_t firebase_perf_v1_NetworkRequestMetric_CustomAttributesEntry_fields[3] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, firebase_perf_v1_NetworkRequestMetric_CustomAttributesEntry, key, key, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, CALLBACK, OTHER, firebase_perf_v1_NetworkRequestMetric_CustomAttributesEntry, value, key, 0),
    PB_LAST_FIELD
};
...
const pb_field_t firebase_perf_v1_PerfSession_fields[3] = {
    ...
    PB_FIELD(  2, UENUM   , REPEATED, CALLBACK, OTHER, firebase_perf_v1_PerfSession, session_verbosity, session_id, 0),
    PB_LAST_FIELD
};
...
const pb_field_t firebase_perf_v1_GaugeMetric_fields[6] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, CALLBACK, OTHER, firebase_perf_v1_GaugeMetric, cpu_metric_readings, session_id, &firebase_perf_v1_CpuMetricReading_fields),
    ...
    PB_FIELD(  4, MESSAGE , REPEATED, CALLBACK, OTHER, firebase_perf_v1_GaugeMetric, android_memory_readings, gauge_metadata, &firebase_perf_v1_AndroidMemoryReading_fields),
    PB_FIELD(  5, MESSAGE , REPEATED, CALLBACK, OTHER, firebase_perf_v1_GaugeMetric, ios_memory_readings, android_memory_readings, &firebase_perf_v1_IosMemoryReading_fields),
    PB_LAST_FIELD
};
...
const pb_field_t firebase_perf_v1_ApplicationInfo_CustomAttributesEntry_fields[3] = {
    PB_FIELD(  1, BYTES   , OPTIONAL, CALLBACK, FIRST, firebase_perf_v1_ApplicationInfo_CustomAttributesEntry, key, key, 0),
    PB_FIELD(  2, BYTES   , OPTIONAL, CALLBACK, OTHER, firebase_perf_v1_ApplicationInfo_CustomAttributesEntry, value, key, 0),
    PB_LAST_FIELD
};
