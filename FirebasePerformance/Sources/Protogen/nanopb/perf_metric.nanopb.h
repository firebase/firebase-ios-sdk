...
typedef struct _firebase_perf_v1_PerfSession {
    ...
    pb_callback_t session_verbosity;
...
typedef struct _firebase_perf_v1_GaugeMetric {
    pb_bytes_array_t *session_id;
    pb_callback_t cpu_metric_readings;
    bool has_gauge_metadata;
    firebase_perf_v1_GaugeMetadata gauge_metadata;
    pb_callback_t android_memory_readings;
    pb_callback_t ios_memory_readings;
...
#define firebase_perf_v1_TraceMetric_init_default {NULL, false, 0, false, 0, false, 0, 0, NULL, {{NULL}, NULL}, 0, NULL, {{NULL}, NULL}}
#define firebase_perf_v1_TraceMetric_CountersEntry_init_default {{{NULL}, NULL}, false, 0}
#define firebase_perf_v1_TraceMetric_CustomAttributesEntry_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define firebase_perf_v1_NetworkRequestMetric_init_default {NULL, false, _firebase_perf_v1_NetworkRequestMetric_HttpMethod_MIN, false, 0, false, 0, false, 0, NULL, false, 0, false, 0, false, 0, false, 0, false, _firebase_perf_v1_NetworkRequestMetric_NetworkClientErrorReason_MIN, 0, NULL, {{NULL}, NULL}}
#define firebase_perf_v1_NetworkRequestMetric_CustomAttributesEntry_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define firebase_perf_v1_PerfSession_init_default {NULL, {{NULL}, NULL}}
#define firebase_perf_v1_GaugeMetric_init_default {NULL, {{NULL}, NULL}, false, firebase_perf_v1_GaugeMetadata_init_default, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define firebase_perf_v1_ApplicationInfo_CustomAttributesEntry_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define firebase_perf_v1_TraceMetric_init_zero   {NULL, false, 0, false, 0, false, 0, 0, NULL, {{NULL}, NULL}, 0, NULL, {{NULL}, NULL}}
#define firebase_perf_v1_TraceMetric_CountersEntry_init_zero {{{NULL}, NULL}, false, 0}
#define firebase_perf_v1_TraceMetric_CustomAttributesEntry_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
#define firebase_perf_v1_NetworkRequestMetric_init_zero {NULL, false, _firebase_perf_v1_NetworkRequestMetric_HttpMethod_MIN, false, 0, false, 0, false, 0, NULL, false, 0, false, 0, false, 0, false, 0, false, _firebase_perf_v1_NetworkRequestMetric_NetworkClientErrorReason_MIN, 0, NULL, {{NULL}, NULL}}
#define firebase_perf_v1_NetworkRequestMetric_CustomAttributesEntry_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
#define firebase_perf_v1_PerfSession_init_zero   {NULL, {{NULL}, NULL}}
#define firebase_perf_v1_GaugeMetric_init_zero   {NULL, {{NULL}, NULL}, false, firebase_perf_v1_GaugeMetadata_init_zero, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define firebase_perf_v1_ApplicationInfo_CustomAttributesEntry_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
