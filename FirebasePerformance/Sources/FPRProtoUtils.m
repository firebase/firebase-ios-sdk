...
//  [dictionary enumerateKeysAndObjectsUsingBlock:^(NSString *_Nonnull key, NSNumber *_Nonnull
//  value,
//                                                  BOOL *_Nonnull stop) {
...
//  static dispatch_once_t onceToken;
//  dispatch_once(&onceToken, ^{
//    reachabilityRef = SCNetworkReachabilityCreateWithName(kCFAllocatorSystemDefault,
//    "google.com");
//  });
//
