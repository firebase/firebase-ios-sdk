...
/**
    @brief Errors with the code @c FIRAuthErrorCodeEmailAlreadyInUse may contain an
        @c NSError.userInfo dictinary object which contains this key. The value associated with this
        key is an NSString of the email address that is already in use.
 */
