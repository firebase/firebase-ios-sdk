...
/**
    The type of block invoked when a list of identity providers for a given email address is
        requested.
...
/**
    The type of block invoked when verifying that an out of band code should be used to
...
/**
    Keys used to retrieve operation data from a `FIRActionCodeInfo` object by the
        `dataForKey` method.
  */
...
/**
    ...
    This method will only exist until the next major Firebase release following 4.x.x.
...
/**
    Convenience method for `signInAndRetrieveDataWithCredential:completion:` This method
...
/**
    Whether the specific URL is handled by `FIRAuth` .
...
/**
    Whether the specific remote notification is handled by `FIRAuth` .
