...
/**
    Creates an `FIRAuthCredential` for the phone number provider identified by the
...
/**
    Please use the `provider` or `providerWithAuth:` methods to obtain an instance of
