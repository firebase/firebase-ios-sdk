# 2019-03-19 -- v3.4.0
- Adding image support for notification. Enable service extension and use FIRMessagingExtensionHelper API to display image on your notification.
- Adding community support for tvOS.
