# 2019-08-08 -- v4.1.2
# Fixing an issue that always request a token before topic subscription and unsubscription. So that the system doesn't hang when a token is not available. (#3438)
