...
#import "buzz/mobile/proto/GtalkCore.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - GtalkCoreRoot

@implementation GtalkCoreRoot
...
#pragma mark - GtalkCoreRoot_FileDescriptor

static GPBFileDescriptor *GtalkCoreRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[GtalkHeartbeatPing class]
                                     rootClass:[GtalkCoreRoot class]
                                          file:GtalkCoreRoot_FileDescriptor()
                                        fields:fields
...
@dynamic hasFallbackMode, fallbackMode;
@dynamic hasCellOperatorMccmnc, cellOperatorMccmnc;
@dynamic hasMobileNetworkClass, mobileNetworkClass;
...
typedef struct GtalkLoginRequest__storage_ {
  ...
  GtalkLoginRequest_FallbackMode fallbackMode;
  int32_t cellOperatorMccmnc;
  GtalkLoginRequest_MobileNetworkClass mobileNetworkClass;
  NSString *id_p;
  NSString *domain;
  NSString *user;
  NSString *resource;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "fallbackMode",
        .dataTypeSpecific.enumDescFunc = GtalkLoginRequest_FallbackMode_EnumDescriptor,
        .number = GtalkLoginRequest_FieldNumber_FallbackMode,
        .hasIndex = 24,
        .offset = (uint32_t)offsetof(GtalkLoginRequest__storage_, fallbackMode),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldHasEnumDescriptor),
        .dataType = GPBDataTypeEnum,
      },
      {
        .name = "cellOperatorMccmnc",
        .dataTypeSpecific.className = NULL,
        .number = GtalkLoginRequest_FieldNumber_CellOperatorMccmnc,
        .hasIndex = 25,
        .offset = (uint32_t)offsetof(GtalkLoginRequest__storage_, cellOperatorMccmnc),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeInt32,
      },
      {
        .name = "mobileNetworkClass",
        .dataTypeSpecific.enumDescFunc = GtalkLoginRequest_MobileNetworkClass_EnumDescriptor,
        .number = GtalkLoginRequest_FieldNumber_MobileNetworkClass,
        .hasIndex = 26,
        .offset = (uint32_t)offsetof(GtalkLoginRequest__storage_, mobileNetworkClass),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldHasEnumDescriptor),
        .dataType = GPBDataTypeEnum,
      },
    };
...
GPBEnumDescriptor *GtalkLoginRequest_AuthService_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    static const int32_t values[] = {
        ...
        GtalkLoginRequest_AuthService_Iid,
    };
...
BOOL GtalkLoginRequest_AuthService_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case GtalkLoginRequest_AuthService_Iid:
      return YES;
    default:
      return NO;
  }
...
#pragma mark - Enum GtalkLoginRequest_FallbackMode

GPBEnumDescriptor *GtalkLoginRequest_FallbackMode_EnumDescriptor(void) {
  static _Atomic(GPBEnumDescriptor*) descriptor = nil;
  if (!descriptor) {
    static const char *valueNames =
        "FallbackModeUnknown\000FallbackNone\000Fallbac"
        "kAlternativeHostport\000FallbackCellular\000";
    static const int32_t values[] = {
        GtalkLoginRequest_FallbackMode_FallbackModeUnknown,
        GtalkLoginRequest_FallbackMode_FallbackNone,
        GtalkLoginRequest_FallbackMode_FallbackAlternativeHostport,
        GtalkLoginRequest_FallbackMode_FallbackCellular,
    };
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(GtalkLoginRequest_FallbackMode)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
                                     enumVerifier:GtalkLoginRequest_FallbackMode_IsValidValue];
    GPBEnumDescriptor *expected = nil;
    if (!atomic_compare_exchange_strong(&descriptor, &expected, worker)) {
      [worker release];
    }
...
BOOL GtalkLoginRequest_FallbackMode_IsValidValue(int32_t value__) {
  switch (value__) {
    case GtalkLoginRequest_FallbackMode_FallbackModeUnknown:
    case GtalkLoginRequest_FallbackMode_FallbackNone:
    case GtalkLoginRequest_FallbackMode_FallbackAlternativeHostport:
    case GtalkLoginRequest_FallbackMode_FallbackCellular:
      return YES;
    default:
      return NO;
  }
...
#pragma mark - Enum GtalkLoginRequest_MobileNetworkClass

GPBEnumDescriptor *GtalkLoginRequest_MobileNetworkClass_EnumDescriptor(void) {
  static _Atomic(GPBEnumDescriptor*) descriptor = nil;
  if (!descriptor) {
    static const char *valueNames =
        "NetworkClassUnknown\000NetworkClass2G\000Netwo"
        "rkClass3G\000NetworkClass4G\000";
    static const int32_t values[] = {
        GtalkLoginRequest_MobileNetworkClass_NetworkClassUnknown,
        GtalkLoginRequest_MobileNetworkClass_NetworkClass2G,
        GtalkLoginRequest_MobileNetworkClass_NetworkClass3G,
        GtalkLoginRequest_MobileNetworkClass_NetworkClass4G,
    };
    static const char *extraTextFormatInfo = "\003\001g\345\202\000\002g\345\202\000\003g\345\202\000";
    GPBEnumDescriptor *worker =
        [GPBEnumDescriptor allocDescriptorForName:GPBNSStringifySymbol(GtalkLoginRequest_MobileNetworkClass)
                                       valueNames:valueNames
                                           values:values
                                            count:(uint32_t)(sizeof(values) / sizeof(int32_t))
                                     enumVerifier:GtalkLoginRequest_MobileNetworkClass_IsValidValue
...
BOOL GtalkLoginRequest_MobileNetworkClass_IsValidValue(int32_t value__) {
  switch (value__) {
    case GtalkLoginRequest_MobileNetworkClass_NetworkClassUnknown:
    case GtalkLoginRequest_MobileNetworkClass_NetworkClass2G:
    case GtalkLoginRequest_MobileNetworkClass_NetworkClass3G:
    case GtalkLoginRequest_MobileNetworkClass_NetworkClass4G:
      return YES;
    default:
      return NO;
  }
