...
#pragma mark - GtalkExtensionsRoot

@implementation GtalkExtensionsRoot
...
#pragma mark - GtalkExtensionsRoot_FileDescriptor

static GPBFileDescriptor *GtalkExtensionsRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[GtalkRosterQuery class]
                                     rootClass:[GtalkExtensionsRoot class]
                                          file:GtalkExtensionsRoot_FileDescriptor()
                                        fields:fields
