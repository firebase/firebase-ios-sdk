...
typedef GPB_ENUM(GtalkLoginRequest_AuthService) {
  ...
  GtalkLoginRequest_AuthService_Iid = 3,
};
...
typedef GPB_ENUM(GtalkLoginRequest_FallbackMode) {
  GtalkLoginRequest_FallbackMode_FallbackModeUnknown = 0,
  GtalkLoginRequest_FallbackMode_FallbackNone = 1,
  GtalkLoginRequest_FallbackMode_FallbackAlternativeHostport = 2,
  GtalkLoginRequest_FallbackMode_FallbackCellular = 3,
};
 ...
 * the time this source was generated.
 **/
BOOL GtalkLoginRequest_FallbackMode_IsValidValue(int32_t value);

#pragma mark - Enum GtalkLoginRequest_MobileNetworkClass

typedef GPB_ENUM(GtalkLoginRequest_MobileNetworkClass) {
  GtalkLoginRequest_MobileNetworkClass_NetworkClassUnknown = 0,
  GtalkLoginRequest_MobileNetworkClass_NetworkClass2G = 1,
  GtalkLoginRequest_MobileNetworkClass_NetworkClass3G = 2,
  GtalkLoginRequest_MobileNetworkClass_NetworkClass4G = 3,
};
 ...
 * the time this source was generated.
 **/
BOOL GtalkLoginRequest_MobileNetworkClass_IsValidValue(int32_t value);
...
typedef GPB_ENUM(GtalkLoginRequest_FieldNumber) {
  ...
  GtalkLoginRequest_FieldNumber_FallbackMode = 26,
  GtalkLoginRequest_FieldNumber_CellOperatorMccmnc = 27,
  GtalkLoginRequest_FieldNumber_MobileNetworkClass = 28,
};
...
@property(nonatomic, readwrite) GtalkLoginRequest_FallbackMode fallbackMode;

@property(nonatomic, readwrite) BOOL hasFallbackMode;

@property(nonatomic, readwrite) int32_t cellOperatorMccmnc;

@property(nonatomic, readwrite) BOOL hasCellOperatorMccmnc;

@property(nonatomic, readwrite) GtalkLoginRequest_MobileNetworkClass mobileNetworkClass;

@property(nonatomic, readwrite) BOOL hasMobileNetworkClass;
@end
