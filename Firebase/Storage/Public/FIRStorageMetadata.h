 ...
 */
@property(strong, nonatomic, readonly, nullable) NSArray<NSURL *> *downloadURLs __deprecated_msg("Use `StorageReference.downloadURLWithCompletion()` to obtain a current download URL.");
 ...
 * valid token created.
 */
- (nullable NSURL *)downloadURL __deprecated_msg("Use `StorageReference.downloadURLWithCompletion()` to obtain a current download URL.");
