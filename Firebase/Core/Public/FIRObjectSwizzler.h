 ...
 *  to the dynamic subclass. There should be a 1:1 ratio of object swizzlers to swizzled instances.
 */
@interface FIRObjectSwizzler : NSObject
...
/** Gets an associated object in the runtime. This mechanism can be used to simulate adding
 *  properties.
 *
 *  @param object The object that will be queried for the associated object.
 *  @param key The key of the associated object.
...
/** Instantiates an object swizzler using an object it will operate on. Generates a new class pair.
 *
 *  @note There is no need to store this object. After calling -swizzle, this object can be found by
 *      calling -fpr_objectSwizzler
 *
...
/** Copies a selector from an existing class onto the generated dynamic subclass that this object
 *  will adopt. This mechanism can be used to add methods to specific instances of a class.
 *
