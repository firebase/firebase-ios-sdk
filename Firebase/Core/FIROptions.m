...
- (NSString *)libraryVersionID {
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSString *minor = [components objectAtIndex:1];
    minor = ([minor length] == 2) ? minor : [NSString stringWithFormat:@"0%@", minor];
    NSString *patch = [components objectAtIndex:2];
    patch = ([patch length] == 2) ? patch : [NSString stringWithFormat:@"0%@", patch];
