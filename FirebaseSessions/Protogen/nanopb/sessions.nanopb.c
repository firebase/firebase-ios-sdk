...
const pb_field_t firebase_appquality_DataCollectionStatus_fields[3] = {
    PB_FIELD(  1, UENUM   , SINGULAR, STATIC  , FIRST, firebase_appquality_DataCollectionStatus, performance, performance, 0),
    PB_FIELD(  2, UENUM   , SINGULAR, STATIC  , OTHER, firebase_appquality_DataCollectionStatus, crashlytics, performance, 0),
    PB_LAST_FIELD
};

const pb_field_t firebase_appquality_ApplicationInfo_fields[7] = {
    PB_FIELD(  1, BYTES   , SINGULAR, CALLBACK, FIRST, firebase_appquality_ApplicationInfo, app_id, app_id, 0),
    PB_FIELD(  2, BYTES   , SINGULAR, CALLBACK, OTHER, firebase_appquality_ApplicationInfo, device_model, app_id, 0),
    PB_FIELD(  3, BYTES   , SINGULAR, CALLBACK, OTHER, firebase_appquality_ApplicationInfo, development_platform_name, device_model, 0),
    PB_FIELD(  4, BYTES   , SINGULAR, CALLBACK, OTHER, firebase_appquality_ApplicationInfo, development_platform_version, development_platform_name, 0),
    PB_ANONYMOUS_ONEOF_FIELD(platform_info,   5, MESSAGE , ONEOF, STATIC  , OTHER, firebase_appquality_ApplicationInfo, android_app_info, development_platform_version, &firebase_appquality_AndroidApplicationInfo_fields),
    PB_ANONYMOUS_ONEOF_FIELD(platform_info,   6, MESSAGE , ONEOF, STATIC  , UNION, firebase_appquality_ApplicationInfo, apple_app_info, development_platform_version, &firebase_appquality_AppleApplicationInfo_fields),
    PB_LAST_FIELD
};

const pb_field_t firebase_appquality_AndroidApplicationInfo_fields[4] = {
    PB_FIELD(  1, BYTES   , SINGULAR, CALLBACK, FIRST, firebase_appquality_AndroidApplicationInfo, package_name, package_name, 0),
    PB_FIELD(  2, BYTES   , SINGULAR, CALLBACK, OTHER, firebase_appquality_AndroidApplicationInfo, sdk_version, package_name, 0),
    PB_FIELD(  3, BYTES   , SINGULAR, CALLBACK, OTHER, firebase_appquality_AndroidApplicationInfo, version_name, sdk_version, 0),
    PB_LAST_FIELD
};

const pb_field_t firebase_appquality_AppleApplicationInfo_fields[5] = {
    PB_FIELD(  1, BYTES   , SINGULAR, CALLBACK, FIRST, firebase_appquality_AppleApplicationInfo, bundle_short_version, bundle_short_version, 0),
    PB_FIELD(  2, BYTES   , SINGULAR, CALLBACK, OTHER, firebase_appquality_AppleApplicationInfo, sdk_version, bundle_short_version, 0),
    PB_FIELD(  3, MESSAGE , SINGULAR, STATIC  , OTHER, firebase_appquality_AppleApplicationInfo, network_connection_info, sdk_version, &NetworkConnectionInfo_fields),
    PB_FIELD(  4, UENUM   , SINGULAR, STATIC  , OTHER, firebase_appquality_AppleApplicationInfo, os_name, network_connection_info, 0),
    PB_LAST_FIELD
};
