...
/// LegacySettingsCacheClient is responsible for accessing the cache that Settings are stored in.
protocol LegacySettingsCacheClient: Sendable {
...
final class LegacySettingsCache: LegacySettingsCacheClient {
