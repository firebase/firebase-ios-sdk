...
typedef struct _fm_MessagingClientEventExtension {
    fm_MessagingClientEvent messaging_client_event;
...
#define fm_MessagingClientEventExtension_init_default {fm_MessagingClientEvent_init_default}
...
#define fm_MessagingClientEventExtension_init_zero {fm_MessagingClientEvent_init_zero}
