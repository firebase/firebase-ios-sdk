...
@protocol FIRMessagingStoreDelegate <NSObject>
 ...
 */
@interface FIRMessagingStore : NSObject

/**
 *  The delegate set in the initializer which is notified of changes in the store.
 */
@property(nonatomic, readonly, weak) NSObject<FIRMessagingStoreDelegate> *delegate;
