...
/**
 * Creates a Cloud Functions client with the given app and region. If an instance of Functions
 * associated with the given app already exists, the region parameter will be ignored.
 * @param app The app for the Firebase project.
 * @param region The region for the http trigger, such as "us-central1".
 */
...
/**
 * Creates a Cloud Functions client with the given app and region. If an instance of Functions
 * associated with the given app already exists, the custom domain will be ignored.
 * @param app The app for the Firebase project.
 * @param customDomain A custom domain for the http trigger, such as "https://mydomain.com".
 */
+ (instancetype)functionsForApp:(FIRApp *)app
